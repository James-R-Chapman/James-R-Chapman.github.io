...
hubs: "TryHackMe/Learn/Linux Fundamentals Part 3"
identifier: "20250904T000002"
source_id: "285c1f37-dd4f-4c9e-a7ed-b7aa8fddceb1"
source_urls: "(https://tryhackme.com/room/linuxfundamentalspart3)"
source_path: "Learn/Linux Fundamentals Part 3/20250904T000002--tryhackme-linux-fundamentals-part-3__tryhackme.md"
---
...
Deploying Your Linux Machine
 ...
 Start Machine Then scroll to the top of the page to see the deployment information similar to the screenshot below.

![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/5de96d9ca744773ea7ef8c00-1735933536957.png)
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/5de96d9ca744773ea7ef8c00-1735933567132.png)

**Use The Following Credentials:** IP Address: **MACHINE_IP** Username: **tryhackme** Password: **tryhackme**
...
VIM is a much more advanced text editor. Whilst you're not expected to know all advanced features, it's helpful to mention it for powering up your Linux skills.
 ...
 ![Image 3](https://assets.tryhackme.com/additional/linux-fundamentals/part3/vim1.png)
...
**Variable** **Value** The IP address of the remote system 192.168.1.30User on the remote systemubuntuName of the file on the local systemimportant.txtName that we wish to store the file as on the remote systemtransferred.txtWith this information, let's craft our `scp` command (remembering that the format of SCP is just SOURCE and DESTINATION)

`scp important.txt ubuntu@192.168.1.30:/home/ubuntu/transferred.txt`

And now let's reverse this and layout the syntax for using `scp `to copy a file from a remote computer that we're not logged into

**Variable** **Value** IP address of the remote system192.168.1.30User on the remote systemubuntuName of the file on the remote systemdocuments.txtName that we wish to store the file as on our systemnotes.txtThe command will now look like the following: `scp ubuntu@192.168.1.30:/home/ubuntu/documents.txt notes.txt `
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/5c549500924ec576f953d9fc/room-content/14de6e0470d50317f3b24f4f9aa9297a.png)
...
**Question:** Download the file http://MACHINE_IP:8000/.flag.txt onto the TryHackMe AttackBox. Remember, you will need to do this in a new terminal.What are the contents?

*Answer:* 

     THM{WGET_WEBSERVER}

**Question:** Create and download files to further apply your learning -- see how you can read the documentation on Python3's "HTTPServer" module. Use Ctrl + C to stop the Python3 HTTPServer module once you are finished.
...
![Image 5](https://assets.tryhackme.com/additional/linux-fundamentals/part3/ps1.png)
...
![Image 6](https://assets.tryhackme.com/additional/linux-fundamentals/part3/ps2.png)
...
![Image 7](https://assets.tryhackme.com/additional/linux-fundamentals/part3/top1.png)
...
![Image 8](https://assets.tryhackme.com/additional/linux-fundamentals/part3/process1.png)
...
![Image 9](https://assets.tryhackme.com/additional/linux-fundamentals/part3/bg1.png)
...
![Image 10](https://assets.tryhackme.com/additional/linux-fundamentals/part3/bg2.png)
...
![Image 11](https://assets.tryhackme.com/additional/linux-fundamentals/part3/bg3.png)

With our process backgrounded using either `Ctrl + Z` or the `&` operator, we can use `fg` to bring this back to focus like below, where we can see the `fg` command is being used to bring the background process back into use on the terminal, where the output of the script is now returned to us.

![Image 12](https://assets.tryhackme.com/additional/linux-fundamentals/part3/bg4.png)

![Image 13](https://assets.tryhackme.com/additional/linux-fundamentals/part3/bg5.png)
...
![Image 14](https://assets.tryhackme.com/additional/linux-fundamentals/part3/cron1.png)

A crontab is simply a special file with formatting that is recognised by the `cron` process to execute each line step-by-step. Crontabs require 6 specific values:

ValueDescriptionMINWhat minute to execute atHOURWhat hour to execute atDOMWhat day of the month to execute at
MONWhat month of the year to execute atDOWWhat day of the week to execute atCMDThe actual command that will be executed.
...
![Image 15](https://assets.tryhackme.com/additional/linux-fundamentals/part3/cron2.png)

![Image 16](https://assets.tryhackme.com/additional/linux-fundamentals/part3/cron3.png)
...
![Image 17](https://assets.tryhackme.com/additional/linux-fundamentals/part3/apt1.png)

![Image 18](https://assets.tryhackme.com/additional/linux-fundamentals/part3/apt2.png)
...
![Image 19](https://assets.tryhackme.com/additional/linux-fundamentals/part3/sources1.png)

**2.2.**  And now use Nano or a text editor of your choice to add & save the Sublime Text 3 repository into this newly created file:

![Image 20](https://assets.tryhackme.com/additional/linux-fundamentals/part3/sources2.png)
...
![Image 21](https://assets.tryhackme.com/additional/linux-fundamentals/part3/log1.png)
...
![Image 22](https://assets.tryhackme.com/additional/linux-fundamentals/part3/log2.png)
...
**Question:** Terminate the machine deployed in this room from task 2.

*Answer:* 

     No answer needed

**Question:** Continue your learning in other Linux-dedicated rooms
