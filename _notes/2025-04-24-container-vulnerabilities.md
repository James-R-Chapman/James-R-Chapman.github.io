...
source_id: "bf155173-c7b9-4403-91a9-c9a8d93fec46"
source_urls: "(https://tryhackme.com/room/containervulnerabilitiesDG)"
...
Start MachineThis room will demonstrate some of the common vulnerabilities found in Docker containers and how an attacker can abuse these to escape.
...
![Image 1](https://assets.tryhackme.com/additional/icons/thmpasswordicon.png)

      **Username**    root    **Password**    tryhackme123!     **IP**    MACHINE_IP

### **Answer the questions below**

**Question:** Complete me to progress with this room!
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/1e6a0e70d8eca4267d7af005a587c54e.png)
...
**Vulnerability** **Description** Misconfigured ContainersMisconfigured containers will have privileges that are not necessary for the operation of the container. For example, a container running in "privileged" mode will have access to the host operating system - removing the layers of isolation.Vulnerable ImagesThere have been numerous incidents of popular Docker images being backdoored to perform malicious actions such as crypto mining.Network ConnectivityA container that is not correctly networked can be exposed to the internet. For example, a database container for a web application should only be accessible to the web application container - not the internet.
...
**Question:** Click to proceed to the next task!
...
![Image 3](https://assets.tryhackme.com/additional/docker-rodeo/privileged-container/privileged-container-layers.png)
...
**Question:** Perform the exploit in this task on the target machine. What is the value of the flag that has now been added to the container?
...
**Question:** Name the directory path which contains the docker.sock file on the container.

*Answer:* 

     /var/run

**Question:** Perform the exploit in this task on the target machine. What is the value of the flag located at /root/flag.txt on the host operating system?
...
**Question:** What port number, by default, does the Docker Engine use?
...
**Question:** Perform the exploit in this task on the target machine. What is the flag located in /home/tryhackme/flag.txt?
...
We will come onto how you can prevent these misconfigurations and vulnerabilities in the next [room](https://tryhackme.com/jr/containerhardening), "Container Hardening"

### **Answer the questions below**

**Question:** Click me to finish the room!
