---
layout: post
title: "TryHackMe  - Credentials Harvesting"
date: 2025-08-27
tags: ["tryhackme"]
categories: [tryhackme]
hubs: "TryHackMe/Red Teaming/Compromising Active Directory"
identifier: "20250827T000001"
source_id: "a49f9cf9-082e-4124-b9e4-81c47355ba0c"
source_urls: "(https://tryhackme.com/room/credharvesting)"
...
**Question:** I have completed room prerequisites and am ready to learn about Credentials Harvesting!
...
Start MachineCredentials Harvesting
...
**Question:** Using the "reg query" command, search for the value of the "flag" keyword in the Windows registry?
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/1af2123f694b7386364b53ae6259b8de.png)
...
**Question:** If yes, try removing the protection and dumping the memory using Mimikatz. Once you have done, hit Complete.
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/2ee895dc640303b236e795c1f7e5df7a.png)
...
**Question:** Apply the technique discussed in this task to dump the NTDS file locally and extract hashes. What is the target system bootkey value? Note: Use thm.red/thm as an Active Directory user since it has administrator privileges!
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/ecdb1fcaee158d79297978a49d52b9dd.png)
...
**Question:** Follow the technique discussed in this task to get the LAPS password. What is the LAPs Password for Creds-Harvestin computer?
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/81bf1dad6425f8f06b0026f4e748f193.png)
...
**Question:** Good work on finishing the room and keep learning!
