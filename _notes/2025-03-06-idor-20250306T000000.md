...
identifier: "20250306T000000"
source_id: "ee6f563e-5c34-45ff-aed2-d95633d32b0c"
source_urls: "(https://tryhackme.com/room/idor)"
source_path: "Web Fundamentals/Introduction to Web Hacking/20250306T000000--idor__tryhackme.md"
---
...
View SiteImagine you've just signed up for an online service, and you want to change your profile information. The link you click on goes to http://online-service.thm/profile?user_id=1305, and you can see your information.
...
**Question:** What is the Flag from the IDOR example website?
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5efe36fb68daf465530ca761/room-content/5f2cbe5c4ab4a274420bc9a9afc9202d.png)
...
**Hashed IDs** Hashed IDs are a little bit more complicated to deal with than encoded ones, but they may follow a predictable pattern, such as being the hashed version of the integer value. For example, the Id number 123 would become 202cb962ac59075b964b07152d234b70 if md5 hashing were in use.
...
**Where are they located?** The vulnerable endpoint you're targeting may not always be something you see in the address bar. It could be content your browser loads in via an AJAX request or something that you find referenced in a JavaScript file.
...
Start MachineBegin by pressing the **Start Machine**  button; once started, click the below link and open it in a new browser tab:
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5efe36fb68daf465530ca761/room-content/5d71d3fe747a8c8934564feddfc69f75.png)
...
**Question:** What is the username for user id 1?

*Answer:* 

     adam84

**Question:** What is the email address for user id 3?
