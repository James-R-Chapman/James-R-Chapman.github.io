...
source_id: "36956695-b531-43d9-8bf4-810ae1e7dca8"
...
#+url: (https://tryhackme.com/room/dombasedattacks)

:PROPERTIES:
:ID:           4afe59be-fcf8-4a8d-b317-2b157302488a
:ROAM_ALIASES:
:CREATED:      2025-05-18
:END:
...
**Question:** I am ready to learn about DOM-based attacks!
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/8015a8c076c525e3a23d7e1b4224b41b.png)
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/71e76d68460b0b8f7a1dcced921db74a.png)
...
**Question:** What JavaScript command can be used to create new HTML elements?

*Answer:* 

     createElement

**Question:** What JavaScript command can be used to get the cookie values from the DOM?
...
**Question:** Should security be implemented client-side or server-side?

*Answer:* 

     Server-Side

**Question:** What control can be implemented to ensure that bad user data does not make its way through?
...
**Question:** What do we call the location where untrusted user input made its way into the data pipeline?

*Answer:* 

     Source

**Question:** What do we call the function where untrusted user input is reflected back in the application, leading to a successful attack?
...
**Question:** What was the most common source for DOM-based XSS attacks?

*Answer:* 

     URL Fragments

**Question:** What control implemented by modern browsers prevent us from using this source?
...
**Question:** What flag prevents JavaScript from gaining access to cookie values?

*Answer:* 

     HTTPOnly

**Question:** What security control, that limits where content can be loaded from, makes it harder to weaponise XSS?
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/93dd95e4214248d5c894a06dddf9b8e9.png)

If you simply use View Page Source, this doesn't really help you a lot:

![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/c8b45044dced74bb2b0adb284920e100.png)
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/0ec798edaf330f082617627ea8d086de.png)
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/ceb2cd10366bed7e409e364c9618945f.png)
...
**Question:** What is the source field name that makes the application vulnerable to XSS?

*Answer:* 

     person

**Question:** What is the sink Vue directive that makes the application vulnerable to XSS?

*Answer:* 

     v-html

**Question:** What is the value of the flag that you receive once you deleted all the birthdays?
...
**Question:** I understand DOM-based XSS and understand that user data should not even be trusted as safe client-side!
