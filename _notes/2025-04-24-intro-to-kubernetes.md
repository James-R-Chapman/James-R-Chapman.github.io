...
source_id: "39f5f09b-c081-4155-9bf3-5f95bcc9cc73"
source_urls: "(https://tryhackme.com/room/introtok8s)"
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/3afbfcf74be2eb28be74009467758d5f.png)
...
**Question:** Which benefit of Kubernetes means that it can run anywhere on any type of infrastructure?

*Answer:* 

     highly portable

**Question:** Fill in the blank "Kubernetes is a _________ _____________ system".
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/98b54b6b8427fae556be0cdd516b9e36.svg)

Kubernetes Nodes
Kubernetes workloads (applications) are run inside containers, which are placed in a pod. These pods run on nodes. When talking about node architecture, there are two types to consider. The **control plane**  (also known as "master node") and **worker nodes** . Both of these have their own architecture/components, so let's take a look at them. Nodes can either be a virtual or physical machine. Think of it this way: if applications run in containers which are placed in a pod, nodes contain all the services necessary to run pods.**** **Kubernetes Cluster** 
At the highest level, we have our Kubernetes Cluster; put simply, a Cluster is just a set of nodes. 
The Kubernetes Control Plane**** The control plane manages the worker nodes and pods in the cluster. It does this with the use of various components. Take a look at each of the components and what they are responsible for. Then see them all put together in a control plane architecture diagram.
**Kube-apiserver** 
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/84f898f84e80373f4a4a34e1f658d914.svg)
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/1bf22d1f65ab408e71d15d5049d11129.svg)
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/1eba5a686238be009bc802dd419a09c8.svg)

### **Answer the questions below**

**Question:** What is the smallest deployable unit of computing you can create in Kubernetes?

*Answer:* 

     pod

**Question:** Which control plane component is a key/value store which contains data pertaining to the cluster and its current state?

*Answer:* 

     etcd

**Question:** Which worker node component is responsible for network communication within the cluster?
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/3c0a1d5471d84bd4b86ae3e5a9fefa1f.svg)
...
![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/263deb8228845aed0db78319097bd63b.svg)
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/1b0ab1f0b6ee779c1ee6f2a3f4d4924c.svg)
...
**Question:** Which Kubernetes component exposes pods and serves as an access point?

*Answer:* 

     service

**Question:** Which Kubernetes component can guarantee the availability of X number of pods?

*Answer:* 

     replicaset

**Question:** What Kubernetes component is used to define a desired state?
...
![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/a0872c63c555b82e63ce1ea3dbed6c42.svg)
...
**Question:** In a config file, you have just declared that you want 4 nginx pods. In which one of the 'required fields' has this been declared?

*Answer:* 

     spec

**Question:** The configuration file is for a deployment. In which one of the 'required fields' is this declared?

*Answer:* 

     kind

**Question:** The pods in this deployment will be exposed by a service. In the service configuration file, the target port was set to 80. What should you put as the 'containerPort'?
...
From here, you can run any command you want from within the container itself. Maybe you want to snoop around for your security analysis or run a command to test connectivity from the container.**** **Kubectl port-forward** 
...
**Question:** ...troubleshoot a pod by gathering some details about it?

*Answer:* 

     describe

**Question:** ...access the container's shell?

*Answer:* 

     exec

**Question:** ...check the status of running pods?

*Answer:* 

     get

**Question:** ...turn a defined configuration (YAML file) into a running process?
...
![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/3d57119b77c26780bd73a7d282bee799.png)
...
**Secure your Pods!** **** Let's begin with a few ways to secure the pods themselves. Some best practices for pod security include:
...
![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/6269219b0a19bf47cf26f89bee511374.png)
...
**Question:** Which best container security practice is used to regulate access to a Kubernetes cluster and its resources?

*Answer:* 

     RBAC

**Question:** What is used to define security policies at 3 levels?

*Answer:* 

     Pod Security Standards

**Question:** What enforces these policies?

*Answer:* 

     Pod Security Admission

**Question:** What Kubernetes object can be used to store sensitive information and should, therefore, be managed securely?
...
![Image 12](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/4de91b9b61095d466cc8c7ae3155f9f7.png)
...
![Image 13](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/df2a998cdc78ae2bfb98eb80650c5241.png)
...
![Image 14](https://tryhackme-images.s3.amazonaws.com/user-uploads/6228f0d4ca8e57005149c3e3/room-content/8f63bc5d74b38ac585541f04b59acf9c.png)
...
**Question:** Can you master the basics of Kubernetes and retrieve the flag?

*Answer:* 

     THM{k8s_k3nno1ssarus}

**Question:** What apiVersion is used for the RoleBinding?
