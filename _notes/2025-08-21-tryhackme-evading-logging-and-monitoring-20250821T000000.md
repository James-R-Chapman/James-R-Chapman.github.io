---
layout: post
title: "TryHackMe  - Evading Logging and Monitoring"
date: 2025-08-21
tags: ["tryhackme"]
categories: [tryhackme]
hubs: "TryHackMe/Red Teaming/Host Evasions"
identifier: "20250821T000000"
source_id: "8349918c-cedb-4db3-9cb7-5f4f3a6f37cd"
source_urls: "(https://tryhackme.com/room/monitoringevasion)"
...
Start MachineOne of the largest obstacles in an attacker’s path is logging and monitoring. Unlike anti-virus and **EDR**  (**E** ndpoint **D** etection and **R** esponse) solutions, logging creates a physical record of activity that can be analyzed for malicious activity.
...
How a device is monitored will depend on the environment and preferences of the corporation. Teams may decide not to monitor some devices at all. Generally, a monitoring solution will begin at the host device, collecting application or event logs. Once logs are created, they can be kept on the device or sent to an event collector/forwarder. Once they are off the device, the defense team decides how to aggregate them; this is generally accomplished using an indexer and a **SIEM**  (**S** ecurity **I** nformation and **E** vent **M** anager).
 ...
 ![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/5f73c10ed1fd5e7b28b2476d4cc6b375.png)
...
**Component** **Purpose** ControllersBuild and configure sessionsProvidersGenerate eventsConsumersInterpret eventsWe will cover each component and how it is instrumented in more depth in the next task.
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/db1b84e4a474da69a73f6678fe04858e.png)
...
**Question:** What ETW component will build and configure sessions?

*Answer:* 

     Controllers

**Question:** What event ID logs when a user account was deleted?
...
**Question:** How many total events can be used to track event tampering?

*Answer:* 

     3

**Question:** What event ID logs when the log file was cleared?
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/dc8217f5aecbcc08d609c3299756da08.png)
...
**Question:** What reflection assembly is used?

*Answer:* 

     PSEtwLogProvider

**Question:** What field is overwritten to disable ETW?
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/fd799172fc4bcea01ddf4b59ecaa4ca3.png)
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/52fd846d5fa1e76948ac47d563ad6228.png)
...
**Question:** What is the base address for the ETW security check before it is patched?

*Answer:* 

     779f245b

**Question:** What is the non-delimited opcode used to patch ETW for x64 architecture?
...
**Question:** How many total events are enabled through script block and module providers?

*Answer:* 

     2

**Question:** What event ID will log script block execution?
...
**Question:** What event IDs can be disabled using this technique? (lowest to highest separated by a comma)

*Answer:* 

     4103, 4104

**Question:** What provider setting controls 4104 events?
...
**Question:** What type of logging will this method prevent?

*Answer:* 

     Module logging

**Question:** What target module will disable logging for all Microsoft utility modules?
...
Start Machine![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/2c05455a55ed2fcde589b34e918518cd.png)
 ...
 *Solution Walkthrough (Click to read)* To begin this scenario we need to consider the environment that we are in. We are given the information that they are monitoring web traffic, but how are they accomplishing that? Do they have PowerShell logging enabled? Do they have Sysmon installed? Most of these questions can be answered through manual enumeration or looking for the settings to enable features as discussed in this room.
...
**Question:** Enter the flag obtained from the desktop after executing the binary.
