...
source_id: "32bc20ad-3306-494b-87b6-47e08e50f2dd"
...
:PROPERTIES:
:ID:           76655ff5-2fa7-4e26-905b-3671687129f8
:ROAM_ALIASES:
:CREATED:      2025-05-21
:END:
...
Before attempting this room, you must complete the [HTTP Request Smuggling](https://tryhackme.com/room/httprequestsmuggling) room. You must also be comfortable using proxies like [Burp](https://tryhackme.com/module/learn-burp-suite) or [ZAP](https://tryhackme.com/room/learnowaspzap).
...
**Question:** Deploy the VM before continuing.
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/b62f90be37525447e4a9118b906f1291.svg)
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/25f541a57c89cb198f879c7fefee15ec.png)
...
**Question:** Which version of the HTTP protocol uses \r\n to separate headers in a request?

*Answer:* 

     HTTP/1.1

**Question:** Which version of the HTTP protocol uses a binary format and clearly defines boundaries for elements in requests/responses?
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/9d4081b19fc689e4c7d5dc74908cf2fa.svg)
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/5558498a8ce3e4e55944215fc0da7236.svg)
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/8f01b7f9b691452f47a11b6363d5711b.svg)
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/60cc684893cd19e782fb0178285e93fd.svg)
...
![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/62d1c36e7c84315008fdfb09519c218f.svg)
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/b07be99d2c0be4b83525a9b52f2e6e33.svg)
...
The application can be accessed via [https://MACHINE_IP:8000/](https://machine_ip:8000/) and simulates an extremely simple social network. In this case, you can see your own posts (a single one) and like and dislike them. We will use the H2.CL vulnerability to force other users to like our post (the lab simulates a victim user).
...
![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/231ba2eeb250ed651e2ed8acaca25012.svg)
...
![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/ef45d093ef847c77886f3240450040f8.svg)
...
![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/f7fcfa8166c910d29d31c2eba2433c7e.png)
...
![Image 12](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/ed49e94f3ae7dc7030e1923b58d62176.png)
...
**Question:** Repeat the request shown in the practical example against the app and wait for a user to fall for our trap. What is the username of the victim user who liked our post?
...
![Image 13](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/a2ae4b71b8a024459c2cb4bc37dfcb1d.svg)

In the following three tasks, we will use an old version of HAProxy, vulnerable to [CVE-2019-19330](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-19330) as our frontend proxy. This version allows request smuggling by using the CRLF injection technique. The vulnerable backend application will be accessible through the proxy at [https://MACHINE_IP:8100](https://machine_ip:8100/).
...
![Image 14](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/8b293f1a35622264fdd6a7166f40fa52.svg)
...
![Image 15](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/929da265f2a2e96245964dbd3893be4e.svg)
...
![Image 16](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/fea04890f95f87e73a433538916e34a5.svg)
...
![Image 17](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/fa150fe0acf8e8eac8649f226989afa8.png)
...
![Image 18](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/4fa11b2e366568fa088aec13a4c47f87.png)
...
![Image 19](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/128510f767c9bda706c8d5ce909e614d.png)
...
![Image 20](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/dedb9aae533c86cc1c3eda26cf4536a5.png)
...
![Image 21](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/887b127fbf551057c96e21c6c80799c5.png)
...
**Question:** What's the value of the leaked internal header?
...
![Image 22](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/5380e4baf546ad4c302e20e7034c0a68.png)
...
![Image 23](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/7595555b86fef0a78f23b63bedba045b.svg)
...
**Question:** What is the value of the flag in /admin?
...
In any of those cases, the attacker can add arbitrary content to the website, which can be cached by the proxy and associated with any URL (existing or not). In the case of our application, we have an upload functionality at our disposal ([https://MACHINE_IP:8100/upload](https://machine_ip:8100/upload)). We can use it to upload any payload we want cached later.

![Image 24](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/6d99b711e1f7288154412c971a60b629.png)

Executing the Plan

Our goal in this task will be to steal cookies from any user visiting [https://MACHINE_IP:8100/](https://machine_ip:8100/). The lab already simulates a victim user, and the flag for this task is in that user's cookies.
...
![Image 25](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/19a63985e226cb553972ee3448af1365.png)
...
![Image 26](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/b97db693a7c07ee9c72d785351090281.svg)
...
![Image 27](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/f2cc2a0be416384bbba3ce79d1dd37bb.svg)
...
**Question:** What is the value of the cookie stolen using web cache poisoning?
...
![Image 28](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/b9b8f7e4dab53f60e6dbb460afe9e11e.svg)
...
![Image 29](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/762b25a0f5fbc9f856a6436b2c1e1221.svg)
...
For this scenario, you will be attacking the application exposed in [https://MACHINE_IP:8200](https://machine_ip:8200/). The application is served through a HAProxy instance with default configurations. The application exposes two endpoints:

1. The `/` endpoint contains a simple website and is allowed through the proxy.
2. The `/private` endpoint is not allowed through the proxy. You can try accessing it at [https://MACHINE_IP:8200/private](https://machine_ip:8200/private) and you should get a `403 Forbidden` response.
...
**Question:** What's the value of the flag on /private?
