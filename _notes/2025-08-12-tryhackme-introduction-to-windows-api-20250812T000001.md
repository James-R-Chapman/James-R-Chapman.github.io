---
layout: post
title: "TryHackMe  - Introduction to Windows API"
date: 2025-08-12
tags: [["tryhackme"]]
categories: [tryhackme]
hubs: "TryHackMe/Red Teaming/Host Evasions"
identifier: "20250812T000001"
source_id: "1dcbfa8a-7509-4eee-84e1-98ca946be541"
...
**User mode** **Kernel mode** No direct hardware access
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/3099761e193a0fa0eab05432b07e0537.png)
...
**Question:** Does a process in the user mode have direct hardware access? (Y/N)

*Answer:* 

     N

**Question:** Does launching an application as an administrator open the process in kernel mode? (Y/N)
...
**Layer** **Explanation** API
A top-level/general term or theory used to describe any call found in the win32 API structure.
Header files or imports
Defines libraries to be imported at run-time, defined by header files or library imports. Uses pointers to obtain the function address.
Core DLLs
A group of four DLLs that define call structures. (KERNEL32, USER32, and ADVAPI32). These DLLs define kernel and user services that are not contained in a single subsystem.
Supplemental DLLs
Other DLLs defined as part of the Windows API. Controls separate subsystems of the Windows OS. ~36 other defined DLLs. (NTDLL, COM, FVEAPI, etc.)
Call Structures
Defines the API call itself and parameters of the call.
API Calls
The API call used within a program, with function addresses obtained from pointers.
In/Out Parameters
...
**Question:** What header file imports and defines the User32 DLL and structure?

*Answer:* 

     winuser.h

**Question:** What parent header file contains all other required child and core header files?
...
P/InvokeMicrosoft describes P/Invoke or platform invoke as “a technology that allows you to access structs, callbacks, and functions in unmanaged libraries from your managed code.”
...
**Question:** What overarching namespace provides P/Invoke to .NET?

*Answer:* 

     system

**Question:** What memory protection solution obscures the process of importing API calls?
...
**Character** **Explanation** ARepresents an 8-bit character set with ANSI encoding
WRepresents a Unicode encoding
ExProvides extended functionality or in/out parameters to the API call
...
**Question:** Which character appended to an API call represents an ANSI encoding?

*Answer:* 

     A

**Question:** Which character appended to an API call represents extended functionality?

*Answer:* 

     Ex

**Question:** What is the memory allocation type of 0x00080000 in the VirtualAlloc API call?
...
**Question:** Do you need to define a structure to use API calls in C? (Y/N)
...
**Question:** What method is used to import a required DLL?

*Answer:* 

     DllImport

**Question:** What type of method is used to reference the API call to obtain a struct?
...
**API Call** **Explanation** LoadLibraryA
...
**Question:** Which API call returns the address of an exported DLL function?

*Answer:* 

     GetProcAddress

**Question:** Which API call imports a specified DLL into the address space of the calling process?
...
KeyloggerTo begin analyzing the keylogger, we need to collect which API calls and hooks it is implementing. Because the keylogger is written in C#, it must use P/Invoke to obtain pointers for each call. Below is a snippet of the p/invoke definitions of the malware sample source code.
...
**API Call** **Explanation** SetWindowsHookEx
...
Shellcode LauncherTo begin analyzing the shellcode launcher, we once again need to collect which API calls it is implementing. This process should look identical to the previous case study. Below is a snippet of the p/invoke definitions of the malware sample source code.
...
**API Call** **Explanation** VirtualAllocReserves, commits, or changes the state of a region of pages in the virtual address space of the calling process.
...
**Question:** What Win32 API call is used to obtain a pseudo handle of our current process in the keylogger sample?

*Answer:* 

     GetCurrentProcess

**Question:** What Win32 API call is used to set a hook on our current process in the keylogger sample?

*Answer:* 

     SetWindowsHookEx

**Question:** What Win32 API call is used to obtain a handle from the pseudo handle in the keylogger sample?

*Answer:* 

     GetModuleHandle

**Question:** What Win32 API call is used unset the hook on our current process in the keylogger sample?

*Answer:* 

     UnhookWindowsHookEx

**Question:** What Win32 API call is used to allocate memory for the size of the shellcode in the shellcode launcher sample?

*Answer:* 

     VirtualAlloc

**Question:** What native method is used to write shellcode to an allocated section of memory in the shellcode launcher sample?

*Answer:* 

     Marshal.copy

**Question:** What Win32 API call is used to create a new execution thread in the shellcode launcher sample?

*Answer:* 

     CreateThread

**Question:** What Win32 API call is used to wait for the thread to exit in the shellcode launcher sample?
