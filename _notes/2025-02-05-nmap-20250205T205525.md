...
source_id: "1bf15f7b-db7d-4e24-9431-f239ba2d8099"
source_path: "Network Exploitation Basics/20250205T205525--nmap__tryhackme.md"
---

{% raw %}


### Network Exploitation Basics > Nmap
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5fc2847e1bbebc03aa89fbf2/room-content/8cb7e35f1011d8d147618aa2a2976550.png)

**

## **Answer the questions below**

**Question:** Deploy the attached VM
...
When it comes to hacking, knowledge is power. The more knowledge you have about a target system or network, the more options you have available. This makes it imperative that proper enumeration is carried out before any exploitation attempts are made.
 ...
 ![Image 2](https://i.imgur.com/3XAfRpI.png)
...
**Question:** We should always save the output of our scans -- this means that we only need to run the scan once (reducing network traffic and thus chance of detection), and gives us a reference to use when writing reports for clients.
...
**Question:** Sometimes the results we're getting just aren't enough. If we don't care about how loud we are, we can enable "aggressive" mode. This is a shorthand switch that activates service detection, operating system detection, a traceroute and common script scanning.
How would you activate this setting?

     Answer: -A


**Question:** Nmap offers five levels of "timing" template. These are essentially used to increase the speed your scan runs at. Be careful though: higher speeds are noisier, and can incur errors!
How would you set the timing template to level 5?

     Answer: -T5


**Question:** We can also choose which port(s) to scan.
...
**Question:** A very useful option that should not be ignored:
...
![Image 3](https://muirlandoracle.co.uk/wp-content/uploads/2020/03/image-2.png)

 

![Image 4](https://i.imgur.com/ngzBWID.png)
 ...
 *"... If the connection does not exist (CLOSED), then a reset is sent in response to any incoming segment except another reset. A SYN segment that does not match an existing connection is rejected by this means."*
 ...
 ![Image 5](https://i.imgur.com/vUQL9SK.png)
...
![Image 6](https://i.imgur.com/cPzF0kU.png)

![Image 7](https://i.imgur.com/bcgeZmI.png)
...
![Image 8](https://i.imgur.com/ABCxAwf.png)
- FIN scans (`-sF`) work in an almost identical fashion; however, instead of sending a completely empty packet, a request is sent with the FIN flag (usually used to gracefully close an active connection). Once again, Nmap expects a RST if the port is closed.

![Image 9](https://i.imgur.com/gIzKbEk.png)
- As with the other two scans in this class, Xmas scans (`-sX`) send a malformed TCP packet and expects a RST response for closed ports. It's referred to as an xmas scan as the flags that it sets (PSH, URG and FIN) give it the appearance of a blinking christmas tree when viewed as a packet capture in Wireshark. 

![Image 10](https://i.imgur.com/gKVkGug.png)
...
![Image 11](https://i.imgur.com/aJdVSAP.png)
...
![Image 12](https://i.imgur.com/ijAhZsy.png)
...
![Image 13](https://i.imgur.com/7GV9Wzi.png)
...
![Image 14](https://i.imgur.com/352GgTj.png)
