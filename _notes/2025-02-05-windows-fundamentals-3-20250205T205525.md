...
source_id: "0f4631ce-02f1-4887-a7d3-280be6443f21"
source_path: "Windows Exploitation Basic/20250205T205525--windows-fundamentals-3__tryhackme.md"
---
...
![Image 2](https://assets.tryhackme.com/additional/win-fun3/windows-update2.png)
...
![Image 3](https://assets.tryhackme.com/additional/win-fun3/windows-update2b.png)
...
![Image 4](https://assets.tryhackme.com/additional/win-fun3/windows-update3.png)
...
![Image 5](https://assets.tryhackme.com/additional/win-fun3/windows-security.png)
...
![Image 6](https://assets.tryhackme.com/additional/win-fun3/windows-security2.png)
...
![Image 7](https://assets.tryhackme.com/additional/win-fun3/windows-security1b.png)

Next, we'll look at **Virus & threat protection**.

## **Answer the questions below**

**Question:** In the above image, which area needs immediate attention?
...
![Image 8](https://assets.tryhackme.com/additional/win-fun3/windows-security3.png)
...
![Image 9](https://assets.tryhackme.com/additional/win-fun3/windows-security4.png)
...
![Image 10](https://assets.tryhackme.com/additional/win-fun3/windows-defender-scan.png)
...
![Image 11](https://assets.tryhackme.com/additional/win-fun3/windows-firewall.png)
...
![Image 12](https://assets.tryhackme.com/additional/win-fun3/windows-firewall2.png)
...
![Image 13](https://assets.tryhackme.com/additional/win-fun3/windows-firewall3.png)
...
![Image 14](https://assets.tryhackme.com/additional/win-fun3/windows-firewall4.png)
...
![Image 15](https://assets.tryhackme.com/additional/win-fun3/windows-app-control.png)

**Check apps and files**

- **Windows Defender SmartScreen**helps protect your device by checking for unrecognized apps and files from the web.

![Image 16](https://assets.tryhackme.com/additional/win-fun3/windows-smartscreen.png)
...
![Image 17](https://assets.tryhackme.com/additional/win-fun3/windows-exploit-protection.png)
...
![Image 18](https://assets.tryhackme.com/additional/win-fun3/windows-device-sec.png)

**Core isolation**

- **Memory Integrity** - Prevents attacks from inserting malicious code into high-security processes.

![Image 19](https://assets.tryhackme.com/additional/win-fun3/windows-mem-integrity2.png)
...
![Image 20](https://assets.tryhackme.com/additional/win-fun3/windows-sec-processor.png)

Below are the **Security processor details**.

![Image 21](https://assets.tryhackme.com/additional/win-fun3/windows-tpm.png)
...
![Image 22](https://assets.tryhackme.com/additional/win-fun3/vss1.png)

![Image 23](https://assets.tryhackme.com/additional/win-fun3/vss2.png)
...
There is still so much to explain and cover regarding the Windows OS. As mentioned in the[ Windows Fundamentals 1](https://tryhackme.com/room/windowsfundamentals1xbx) room, "*The content is aimed at those who wish to understand and use the Windows OS on a more comfortable level* ."
