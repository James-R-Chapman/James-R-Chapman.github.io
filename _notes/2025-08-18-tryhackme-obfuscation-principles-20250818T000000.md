---
layout: post
title: "TryHackMe  - Obfuscation Principles"
date: 2025-08-18
tags: [["tryhackme"]]
categories: [tryhackme]
hubs: "TryHackMe/Red Teaming/Host Evasions"
identifier: "20250818T000000"
source_id: "95964d28-8507-493a-a4c0-e2a33aa3aa48"
source_urls: "(https://tryhackme.com/room/obfuscationprinciples)"
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/ab3d8ccd4dcf26c86b2eb53e676b619f.png)
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/54c0a2415cd4fc88a55b154bf297910c.png)
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/974cf87ce312e0885e6e8027f9c1821e.png)
...
**Question:** How many core layers make up the Layered Obfuscation Taxonomy?

*Answer:* 

     4

**Question:** What sub-layer of the Layered Obfuscation Taxonomy encompasses meaningless identifiers?
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/dacc392986614d70d6dc982111077063.png)
...
**Question:** What obfuscation method will break or split an object?

*Answer:* 

     Data Splitting

**Question:** What obfuscation method is used to rewrite static data with a procedure call?
...
Start Machine**Concatenation**  is a common programming concept that combines two separate objects into one object, such as a string.
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/c033d156dae21c3683c5034fe031a452.png)
...
To begin trying to clean this code snippet we need to break it down and understand where the alerts are originating. We can break the snippet where each cmdlet is present (`GetField`, `SetValue`)
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/f9e4be87a9801b500d118e2c83e19c01.png)
...
**Question:** What are junk instructions referred to as in junk code?

*Answer:* 

     Code Stubs

**Question:** What obfuscation layer aims to confuse an analyst by manipulating the code flow and abstract syntax trees?
...
![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/cfc2504b9a4a76682d724413080e3729.png)
...
**Question:** Can logic change and impact the control flow of a program? (T/F)
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/c1a1b8196a13becaa1efec050260c81b.png)
...
**Question:** What flag is found after properly reversing the provided snippet?
...
Start MachineIdentifiable information can be one of the most critical components an analyst can use to dissect and attempt to understand a malicious program. By limiting the amount of identifiable information (variables, function names, etc.), an analyst has, the better chance an attacker has they won't be able to reconstruct its original function.
...
Object NamesObject names offer some of the most significant insight into a program's functionality and can reveal the exact purpose of a function. An analyst can still deconstruct the purpose of a function from its behavior, but this is much harder if there is no context to the function.
...
Code StructureCode structure can be a bothersome problem when dealing with all aspects of malicious code that are often overlooked and not easily identified. If not adequately addressed in both interpreted and compiled languages, it can lead to signatures or easier reverse engineering from an analyst.
