---
layout: post
title: "TryHackMe  - Windows Internals"
date: 2025-07-07
tags: ["tryhackme"]
categories: [tryhackme]
hubs: "TryHackMe/SOC Level 2/Malware Analysis"
identifier: "20250707T000001"
source_id: "4aa23565-f222-4b7b-8706-7663bc350287"
source_urls: "(https://tryhackme.com/room/windowsinternals)"
...
Start MachineOperating systems have a lot more technology and architecture behind them than we may see at first. In this room, we will be observing the Windows operating systems and common internal components.

  

![image](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/d3151008cd1cc025ef9846a619aa6967.png)
...
**Question:** Start the provided machine and move on to the next tasks.
...
![image](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/b14871cd8b0bfa82a57238d58b6ef7fd.png)
...
![image](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/66320022b6b57f3c40e135d66de3c1d9.png)
...
**Question:** Open the provided file: "Logfile.PML" in Procmon and answer the questions below.

*Answer:* 

     No answer needed

**Question:** What is the process ID of "notepad.exe"?

*Answer:* 

     5984

**Question:** What is the parent process ID of the previous process?

*Answer:* 

     3412

**Question:** What is the integrity level of the process?
...
![image](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/9bd1bf463270840b282507e4c590ecf2.png)
...
**Question:** What is the thread ID of the first thread created by notepad.exe?

*Answer:* 

     5908

**Question:** What is the stack argument of the previous thread?
...
![image](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/49fb3abea645c7c5850ce3c83981fe76.png)

  

![image](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/6346370db43e6cc74c2e7602d286e42c.png)
...
**Question:** Read the above and answer the questions below.

*Answer:* 

     No answer needed

**Question:** What is the total theoretical maximum virtual address space of a 32-bit x86 system?

*Answer:* 

     4 GB

**Question:** What default setting flag can be used to reallocate user process address space?
...
**Question:** What is the base address of "notepad.exe"?
...
![image](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/945548ed044eca647bff352a106585bd.png)
...
**Question:** What is the base address of "ntdll.dll" loaded from "notepad.exe"?

*Answer:* 

     0x7ffd0be20000

**Question:** What is the size of "ntdll.dll" loaded from "notepad.exe"?

*Answer:* 

     0x1ec000

**Question:** How many DLLs were loaded by "notepad.exe"?
...
![image](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/a2e6d40803c1d01beedd6e821de2e8d6.png)
...
**Question:** What PE component prints the message "This program cannot be run in DOS mode"?

*Answer:* 

     DOS Stub

**Question:** Open "notepad.exe" in Detect It Easy and answer the questions below.

*Answer:* 

     No answer needed

**Question:** What is the entry point reported by DiE?

*Answer:* 

     000000014001acd0

**Question:** What is the value of "NumberOfSections"?

*Answer:* 

     0006

**Question:** What is the virtual address of ".data"?

*Answer:* 

     00024000

**Question:** What string is located at the offset "0001f99c"?
...
![image](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/2e5b0c2fccd102d477752270054facb2.png)
...
**Question:** Open a command prompt and execute the provided file: "inject-poc.exe" and answer the questions below.

*Answer:* 

     No answer needed

**Question:** Enter the flag obtained from the executable below.
