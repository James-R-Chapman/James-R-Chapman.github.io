...
identifier: "20250430T000002"
source_id: "b41ee982-fda6-4796-8e2e-535c0445cb9a"
source_urls: "(https://tryhackme.com/room/nosqlinjectiontutorial)"
source_path: "Web Application Pentesting/Injection Attacks/20250430T000002--nosql-injection__tryhackme.md"
---
...
**Question:** I am ready to learn about NoSQL Injection attacks!
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1719679544440.png)
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1719679596244.png)
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1719679617512.png)
...
**Question:** What is a group of documents in MongoDB is known as?

_Answer:_

     collection

**Question:** Using the MongoDB Operator Reference, what operator is used to filter data when a field isn't equal to a given value?

_Answer:_

     $ne

**Question:** Following the example of the 3 documents given before, how many documents would be returned by the following filter: ['gender' => ['$ne' => 'female'] , 'age' => ['$gt'=>'65'] ]?
...
Start MachineFirst, let's start the **Virtual Machine** by pressing the **Start Machine** button at the top of this task. You may access the VM using the **AttackBox** or your **VPN** connection. Once the machine is ready, navigate to [http://MACHINE_IP](http://machine_ip/) to start the exercise.
...
**Question:** What type of NoSQL Injection is similar to normal SQL Injection?

_Answer:_

     Syntax

**Question:** What type of NoSQL Injection allows you to modify the behaviour of the query, even if you can't escape the syntax?
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1719679685897.png)

The original captured login request looks like this:

![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1719679753604.png)

We now proceed to intercept another login request and modify the user and pass variables to send the desired arrays:

![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1719679773572.png)

This forces the database to return all user documents and as a result we are finally logged into the application:

![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1719679795855.png)

### **Answer the questions below**

**Question:** When bypassing the login screen using the $ne operator, what is the email of the user that you are logged in as?
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1719679859318.png)
...
![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1719679886213.png)
...
**Question:** There is a user that starts with the letter "p". What is his username?
...
![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1719679978838.png)
...
![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/617be9330b818bf2ed2c31f779be7c17.png)
...
![Image 12](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1719679996762.png)
...
![Image 13](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1719680018918.png)
...
**Question:** One of the users seems to be reusing his password for many services. Find which one and connect through SSH to retrieve the final flag!
...
![Image 14](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/5d471dd234b7fc4eb4edea3c934663c1.png)

**Username** syntax **Password** syntax
...
**Question:** What common character is used to test for injection in both SQL and NoSQL solutions?

_Answer:_

     '

**Question:** What is the email value of the super secret user returned in the last entry?
...
**Question:** I understand NoSQL Injection attacks and acknowledge that user data should never be directly accepted into queries!
