...
identifier: "20250207T000001"
source_id: "da9cdf4c-e3c6-476b-9648-e28228af4fb4"
source_urls: "(https://tryhackme.com/room/wiresharktrafficanalysis)"
...
**Notes** **Wireshark Filters** Global search.
- `tcp`
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/500bb6902ef6b2edb515bb1828088d82.png)

**Closed TCP port (Connect):**

![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/c194773203502d659d72706aa93eae59.png)
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/7025561839f99201724629fae1274f2d.png)
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/0dbf4e7b74ad99f7060241fc37d8d570.png)

**Closed TCP port (SYN):**

![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/488115fed65b69aa95aa2677cf2ae800.png)

The given filter shows the [TCP]() SYN scan patterns in a capture file.

`tcp.flags.syn==1 and tcp.flags.ack==0 and tcp.window_size <= 1024`

![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/d033bde6ee753f070678cc56665d79fa.png)
...
![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/bb88ee3b05687c6ece165ab7e9fe12bf.png)
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/0e63fe522554f08810d7d60b8a331ae7.png)

The given filter shows the UDP scan patterns in a capture file.

`icmp.type==3 and icmp.code==3`

![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/626988e40598f6190c81f59ab3ff813c.png)
...
Answer the questions belowUse the "Desktop/exercise-pcaps/nmap/Exercise.pcapng" file.**** What is the total number of the "TCP Connect" scans?

Correct AnswerWhich scan type is used to scan the TCP port 80?

Correct AnswerHow many "UDP close port" messages are there?

Correct AnswerWhich UDP port in the 55-70 port range is open?

Correct AnswerHint

### **Answer the questions below**

**Question:** Use the "Desktop/exercise-pcaps/nmap/Exercise.pcapng" file.What is the total number of the "TCP Connect" scans?

*Answer:* 

     1000

**Question:** Which scan type is used to scan the TCP port 80?

*Answer:* 

     TCP Connect

**Question:** How many "UDP close port" messages are there?

*Answer:* 

     1083

**Question:** Which UDP port in the 55-70 port range is open?
...
**Notes** **Wireshark filter** Global search
- `arp`
...
![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/ef02b6b0434491aea9eb6957c70c32d2.png)
...
![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/7f0e92a248da129dda0593a299ecb368.png)
...
**Findings** Possible IP address match.
...
![Image 12](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/e02a42c9d4e3f17a94acbae4cacb6b65.png)
...
NotesDetection NotesFindingsPossible IP address match.
1 IP address announced from a MAC address.
...
![Image 13](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/f55ebc1632f6776e074dc29842221b48.png)
...
![Image 14](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/f885817e77449e6898ba3ede164723c4.png)
...
Detection NotesFindingsIP to MAC matches.3 IP to MAC address matches. 
...
Answer the questions belowUse the "Desktop/exercise-pcaps/arp/Exercise.pcapng" file.
What is the number of ARP requests crafted by the attacker?

Correct AnswerWhat is the number of HTTP packets received by the attacker?

Correct AnswerWhat is the number of sniffed username&password entries?

Correct AnswerHintWhat is the password of the "Client986"?

Correct AnswerHintWhat is the comment provided by the "Client354"?

Correct AnswerHint

### **Answer the questions below**

**Question:** Use the "Desktop/exercise-pcaps/arp/Exercise.pcapng" file.What is the number of ARP requests crafted by the attacker?

*Answer:* 

     284

**Question:** What is the number of HTTP packets received by the attacker?

*Answer:* 

     90

**Question:** What is the number of sniffed username&password entries?

*Answer:* 

     6

**Question:** What is the password of the "Client986"?

*Answer:* 

     clientnothere!

**Question:** What is the comment provided by the "Client354"?
...
![Image 15](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/7431eb9671e8ebb2a21d2ff9a08b2faa.png)
...
![Image 16](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/e12db620d6127ad299059e3626f083d7.png)
...
![Image 17](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/9826985c3c3b9f582f7c7c5ed24f93d7.png)

Detecting suspicious activities in chunked files is easy and a great way to learn how to focus on the details. Now use the exercise files to put your skills into practice against a single capture file and answer the questions below!

Answer the questions belowUse the "Desktop/exercise-pcaps/dhcp-netbios-kerberos/dhcp-netbios.pcap" file.
What is the MAC address of the host "Galaxy A30"?

Correct AnswerHintHow many NetBIOS registration requests does the "LIVALJM" workstation have?

Correct AnswerHintWhich host requested the IP address "172.16.13.85"?Correct AnswerUse the "Desktop/exercise-pcaps/dhcp-netbios-kerberos/**kerberos.pcap" file.** 
What is the IP address of the user "u5"? (Enter the address in defanged format.)

Correct AnswerWhat is the hostname of the available host in the Kerberos packets?Correct Answer

### **Answer the questions below**

**Question:** Use the "Desktop/exercise-pcaps/dhcp-netbios-kerberos/dhcp-netbios.pcap" file.What is the MAC address of the host "Galaxy A30"?

*Answer:* 

     9a:81:41:cb:96:6c

**Question:** How many NetBIOS registration requests does the "LIVALJM" workstation have?

*Answer:* 

     16

**Question:** Which host requested the IP address "172.16.13.85"?

*Answer:* 

     Galaxy-A12

**Question:** Use the "Desktop/exercise-pcaps/dhcp-netbios-kerberos/kerberos.pcap" file.What is the IP address of the user "u5"? (Enter the address in defanged format.)
...
![Image 18](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/723f801adc6a95526c2cb39b7ddeee15.png)
...
![Image 19](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/c11641f9df84faa040e2c6c11da08655.png)

Detecting suspicious activities in chunked files is easy and a great way to learn how to focus on the details. Now use the exercise files to put your skills into practice against a single capture file and answer the questions below!

Answer the questions belowUse the "Desktop/exercise-pcaps/dns-icmp/icmp-tunnel.pcap" file.
Investigate the anomalous packets. Which protocol is used in ICMP tunnelling?
Correct AnswerHintUse the "Desktop/exercise-pcaps/dns-icmp/dns.pcap" file.
...
**Question:** Use the "Desktop/exercise-pcaps/dns-icmp/icmp-tunnel.pcap" file.Investigate the anomalous packets. Which protocol is used in ICMP tunnelling?

*Answer:* 

     SSH

**Question:** Use the "Desktop/exercise-pcaps/dns-icmp/dns.pcap" file.Investigate the anomalous packets. What is the suspicious main domain address that receives anomalous DNS queries? (Enter the address in defanged format.)
...
![Image 20](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/8287adaa075c737986e04d026f137e2e.png)

Detecting suspicious activities in chunked files is easy and a great way to learn how to focus on the details. Now use the exercise files to put your skills into practice against a single capture file and answer the questions below!

Answer the questions belowUse the "Desktop/exercise-pcaps/ftp/ftp.pcap" file.**** How many incorrect login attempts are there?

Correct AnswerHintWhat is the size of the file accessed by the "ftp" account?

Correct AnswerHintThe adversary uploaded a document to the FTP server. What is the filename?

Correct AnswerThe adversary tried to assign special flags to change the executing permissions of the uploaded file. What is the command used by the adversary?

Correct Answer

### **Answer the questions below**

**Question:** Use the "Desktop/exercise-pcaps/ftp/ftp.pcap" file.How many incorrect login attempts are there?
...
**Question:** The adversary tried to assign special flags to change the executing permissions of the uploaded file. What is the command used by the adversary?
...
![Image 21](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/8c114d533e1914300bae23b19d3e6f40.png)
...
**Notes** **Wireshark Filters** **Research outcomes** for grabbing the low-hanging fruits:
...
![Image 22](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/8c3bc1fb4090582de2e36452de4d7d3a.png)

Detecting suspicious activities in chunked files is easy and a great way to learn how to focus on the details. Now use the exercise files to put your skills into practice against a single capture file and answer the questions below!
Answer the questions belowUse the "Desktop/exercise-pcaps/http/user-agent.cap" file.
Investigate the user agents. What is the number of anomalous "user-agent" types?Correct AnswerHintWhat is the packet number with a subtle spelling difference in the user agent field?

Correct AnswerUse the "Desktop/exercise-pcaps/http/http.pcapng" file.
Locate the "Log4j" attack starting phase. What is the packet number?

Correct AnswerLocate the "Log4j" attack starting phase and decode the base64 command. What is the IP address contacted by the adversary? (Enter the address in defanged format and exclude "{}".)

Correct Answer

### **Answer the questions below**

**Question:** Use the "Desktop/exercise-pcaps/http/user-agent.cap" file.Investigate the user agents. What is the number of anomalous  "user-agent" types?

*Answer:* 

     6

**Question:** What is the packet number with a subtle spelling difference in the user agent field?

*Answer:* 

     52

**Question:** Use the "Desktop/exercise-pcaps/http/http.pcapng" file.Locate the "Log4j" attack starting phase. What is the packet number?

*Answer:* 

     444

**Question:** Locate the "Log4j" attack starting phase and decode the base64 command. What is the IP address contacted by the adversary? (Enter the address in defanged format and exclude "{}".)
...
NotesWireshark Filter"HTTPS Parameters" for grabbing the low-hanging fruits:
...
![Image 23](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/2558999240f7cc60cfb7588d434f9793.png)
...
- Client Hello: `(http.request
or tls.handshake.type == 1) and !(ssdp)`
- Server Hello:` (http.request
or tls.handshake.type == 2) and !(ssdp)`

![Image 24](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/adad6bec8a257b67664167f52981f820.png)
...
![Image 25](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/17b1557ea94f23b7a9c6851fddbd366b.png)

Adding key log files with the "Edit --> Preferences --> Protocols --> TLS" menu:

![Image 26](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/7461f414bdc9926827dd54d57e7a8825.png)

**Viewing the traffic with/without the key log files:**

![Image 27](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/5df77f4b111b3ae5b7332456046a5ebc.png)
...
Answer the questions belowUse the "Desktop/exercise-pcaps/https/Exercise.pcap" file.
What is the frame number of the "Client Hello" message sent to "accounts.google.com"?Correct AnswerHintDecrypt the traffic with the "KeysLogFile.txt" file. What is the number of HTTP2 packets?

Correct AnswerHintGo to Frame 322. What is the authority header of the HTTP2 packet? (Enter the address in defanged format.)

Correct AnswerInvestigate the decrypted packets and find the flag! What is the flag?

Correct AnswerHint

### **Answer the questions below**

**Question:** Use the "Desktop/exercise-pcaps/https/Exercise.pcap" file.What is the frame number of the "Client Hello" message sent to "accounts.google.com"?

*Answer:* 

     16

**Question:** Decrypt the traffic with the "KeysLogFile.txt" file. What is the number of HTTP2 packets?

*Answer:* 

     115

**Question:** Go to Frame 322. What is the authority header of the HTTP2 packet? (Enter the address in defanged format.)

*Answer:* 

     safebrowsing[.]googleapis[.]com

**Question:** Investigate the decrypted packets and find the flag! What is the flag?
...
![Image 28](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/c8266feccc3836c97ed4fdbd81befc20.png)

Answer the questions belowUse the "Desktop/exercise-pcaps/bonus/Bonus-exercise.pcap" file.
What is the packet number of the credentials using "HTTP Basic Auth"?
Correct AnswerHintWhat is the packet number where "empty password" was submitted?

Correct Answer

### **Answer the questions below**

**Question:** Use the "Desktop/exercise-pcaps/bonus/Bonus-exercise.pcap" file.What is the packet number of the credentials using "HTTP Basic Auth"?

*Answer:* 

     237

**Question:** What is the packet number where "empty password" was submitted?
...
![Image 29](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/448e790da3f31b8566547cd03804b282.png)

Answer the questions belowUse the "Desktop/exercise-pcaps/bonus/Bonus-exercise.pcap" file.
Select packet number 99. Create a rule for "IPFirewall (ipfw)". What is the rule for "denying source IPv4 address"?
Correct AnswerHintSelect packet number 231. Create "IPFirewall" rules. What is the rule for "allowing destination MAC address"?

Correct AnswerHint

### **Answer the questions below**

**Question:** Use the "Desktop/exercise-pcaps/bonus/Bonus-exercise.pcap" file.Select packet number 99. Create a rule for "IPFirewall (ipfw)". What is the rule for "denying source IPv4 address"?

*Answer:* 

     add deny ip from 10.121.70.151 to any in

**Question:** Select packet number 231. Create "IPFirewall" rules. What is the rule for "allowing destination MAC address"?
