---
layout: post
title: "TryHackMe  - Runtime Detection Evasion"
date: 2025-08-21
tags: ["tryhackme"]
categories: [tryhackme]
hubs: "TryHackMe/Red Teaming/Host Evasions"
identifier: "20250821T000001"
source_id: "2601dad9-fbba-4925-a319-6930c9a77aec"
source_urls: "(https://tryhackme.com/room/runtimedetectionevasion)"
...
Start MachineWith the release of PowerShell <3 the Blue Team, Microsoft released AMSI (Anti-Malware Scan Interface), a runtime monitoring solution designed to stop and monitor ongoing threats.

  

![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/3cd5f36d0e880e6ec0f312c1cd52519d.png)
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/661f531c5ed672964a654d56fe28edb9.png)
...
**Question:** Read the above and answer the question below.

*Answer:* 

     No answer needed

**Question:** What runtime detection measure is shipped natively with Windows?
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/8a5a7c3e04fb1ccf3e5391ce397c50a6.png)
...
**Question:** What response value is assigned to 32768?
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/35e16d45ce27145fcdf231fdb8dcb35e.png)
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/efca9438e858f0476a4ffd777c36501a.png)
...
**Question:** Will AMSI be instrumented if the file is only on disk? (Y/N)
...
**Question:** Read the above and practice downgrading PowerShell on the provided machine.

*Answer:* 

     No answer needed

**Question:** Enter the flag obtained from the desktop after executing the command in cmd.exe.
...
**Question:** Read the above and practice leveraging the one-liner on the provided machine.To utilize the one-liner, you can run it in the same session as the desired malicious code or prepend it to the malicious code.

*Answer:* 

     No answer needed

**Question:** Enter the flag obtained from the desktop after executing the command.
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/03c0d034fc2d3c85b98520153b25790e.png)
...
**Question:** Read the above and execute/observe the script on the provided machine.
