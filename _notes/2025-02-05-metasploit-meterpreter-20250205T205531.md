...
source_id: "70f1ee06-a4cb-44ea-aa5d-ffada4e2bb07"
source_path: "Cyber Security 101/Exploitation Basics/20250205T205531--metasploit-meterpreter__tryhackme.md"
---

{% raw %}


### Cyber Security 101 > Exploitation Basics > Metasploit: Meterpreter

### [TryHackMe | Metasploit: Meterpreter](https://tryhackme.com/r/room/meterpreter)
...
Answer the questions belowWhat is the computer name?
Correct AnswerHintWhat is the target domain?

Correct AnswerHintWhat is the name of the share likely created by the user?

Correct AnswerHintWhat is the NTLM hash of the jchambers user?

Correct AnswerHintWhat is the cleartext password of the jchambers user?

Correct AnswerHintWhere is the "secrets.txt" file located? (Full path of the file)

Correct AnswerHintWhat is the Twitter password revealed in the "secrets.txt" file?

Correct AnswerHintWhere is the "realsecret.txt" file located? (Full path of the file)

Correct AnswerHintWhat is the real secret?
