...
identifier: "20250512T000001"
source_id: "1e6634e4-e262-4a48-9059-f3835857aac3"
source_urls: "(https://tryhackme.com/room/prototypepollution)"
source_path: "Web Application Pentesting/Advanced Server-Side Attacks/20250512T000001--prototype-pollution__tryhackme.md"
---
...
Learning Objectives Throughout this room, you will gain a comprehensive understanding of the following key concepts:
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/99cc8d4964ad5650031e743fd3dddcd4.png)
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/de24c38d79efaee48dcc302e6a0b4411.png)
...
- **Class-based Inheritance** : JavaScript also supports classes, which provide a more familiar syntax for defining objects and inheritance. Classes in JavaScript are just syntactical sugar over JavaScript's existing prototype-based inheritance. Under the hood, classes still use prototypes.
 ...
 ![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/c78a12f7d39bbcf14ef8832fefaf930d.svg)
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/ba889a24229822ded96d81b5a97484d0.svg)
...
**Question:** What is the default value of the age property in the user object?

*Answer:* 

     25

**Question:** What is the output once we run regularUser.greet() after executing the prototype code snippet?

*Answer:* 

     Hello, Ben S!

**Question:** After executing the inheritance code snippet, what is the total number of user-defined properties in the ContentCreatorProfile object?ContentCreatorProfile = Object.create(user);
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/d63bebfd81c03b6adbc1ce2e1f59750c.svg)
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/23cf37880af1735915022ab52c32a166.png)
...
**Question:** After executing the above code, if you try to create a new person let josh = Person('Josh'), what would be the output of josh.introduce()?

*Answer:* 

     You've been hacked, I'm Bob

**Question:** What is the name of the property that the attacker polluted?
...
![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/e8b58c7609886ffefb79435e3ac75f23.png)
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/f730a61990991d810591859a18ee0974.png)
...
![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/63a1b1a9086c96548a20e1e607368019.png)
...
```
 ...
 ![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/49e3129bac73bee07c10fe3a1909ac3c.png)
...
**Question:** What is the name of the vulnerable utility the application uses with the _.set function?

*Answer:* 

     lodash

**Question:** In the case of an expression like test[i][j], what would be the controllable parameter that may lead to prototype pollution?
...
![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/ad5f4fc5de32c3280cc67bdeecb40a23.png)
...
![Image 12](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/985c66e44b234218ff481dfb9fc2ef48.png)
...
![Image 13](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/e9c9b96e18ff0aac5850831cb879842d.png)

### **Answer the questions below**

**Question:** What is the default value for the newly added newProperty field?

*Answer:* 

     hacked

**Question:** Which of the following was the main reason behind prototype pollution using merge operation? Write the correct option only.a) Merge should not be used at allb) Absence of sanitisation filters c) Cloning an album of another user

*Answer:* 

     b

**Question:** Create a new property with the name isBanned with default value true. What is the flag value after creating the property? Visit http://MACHINE_IP:8080/getFlag.php to get the flag.
...
![Image 14](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/ac8fe0c7e8bfbfc77c034bc399e1da7f.svg)
...
![Image 15](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/0c526f55ae09c8a2edd3bb9424d67223.png)
...
![Image 16](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/63081473d800a1e88f5a46c40ed09aa5.png)
...
**Question:** What is the flag value after crashing the server through toString()?

*Answer:* 

     THM{CRA5H#D)

**Question:** After overriding the built-in String function toLocaleString(), what is the flag value?
...
Identifying prototype pollution is a tricky problem in any language particularly in JavaScript, because of the way JavaScript lets one

![Image 17](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/fabc3c2e9580c19e3a8cd9c878784ed7.svg)

 object share its features with another. Detecting this problem automatically with software tools is really hard because it's not straightforward like other common website security problems. Each website or web application is different, and figuring out where prototype pollution might happen requires someone to look closely at the website's code, understand how it works, and see where mistakes might be made.
...
**Question:** Does a better understanding of code provide a better insight while identifying prototype pollution? (yea/nay)
...
- ![Image 18](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/e1b7beee648bad62b755daf172eb1b0d.svg)
...
**Question:** What is the name of the process that regularly scans and updates third-party libraries and dependencies?
...
Let us know what you think about this room on our [Discord ](https://discord.gg/tryhackme)channel or [X account](http://x.com/realtryhackme). See you around.
