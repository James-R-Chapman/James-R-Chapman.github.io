---
layout: post
title: "TryHackMe  - Abusing Windows Internals"
date: 2025-08-14
tags: [["tryhackme"]]
categories: [tryhackme]
hubs: "TryHackMe/Red Teaming/Host Evasions"
identifier: "20250814T000000"
source_id: "5cabba3f-1994-4372-aa68-3fbc92319d02"
source_urls: "(https://tryhackme.com/room/abusingwindowsinternals)"
...
Start MachineWindows internals are core to how the Windows operating system functions; this provides adversaries with a lucrative target for nefarious use. Windows internals can be used to hide and execute code, evade detections, and chain with other techniques or exploits.
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/56fa99f2469b86c8660a0a45ae63215f.png)
...
**Process Component** **Purpose** Private Virtual Address Space
...
**Injection Type** **Function** [Process Hollowing](https://attack.mitre.org/techniques/T1055/012/)
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/ba04c5ef220c10b3e174bd1ca77959c6.png)
...
**Question:** Identify a PID of a process running as THM-Attacker to target. Once identified supply the PID as an argument to execute shellcode-injector.exe located in the Injectors directory on the desktop.

*Answer:* 

     No answer needed

**Question:** What flag is obtained after injecting the shellcode?
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/3c36b4470fb04e3bfdbbef0674b79ec2.png)
...
**Question:** Identify a PID of a process running as THM-Attacker to target. Supply the PID and executable name as arguments to execute hollowing-injector.exe located in the injectors directory on the desktop.

*Answer:* 

     No answer needed

**Question:** What flag is obtained after hollowing and injecting the shellcode?
...
**Question:** Identify a PID of a process running as THM-Attacker to target. Supply the PID as an argument to execute thread-injector.exe located in the Injectors directory on the desktop.

*Answer:* 

     No answer needed

**Question:** What flag is obtained after hijacking the thread?
...
**Question:** Identify a PID and name of a process running as THM-Attacker to target. Supply the name and malicious DLL found in the Injectors directory as arguments to execute dll-injector.exe located in the Injectors directory on the desktop.

*Answer:* 

     No answer needed

**Question:** What flag is obtained after injecting the DLL?
...
**Question:** What protocol is used to execute asynchronously in the context of a thread?

*Answer:* 

     Asynchronous Procedure Call

**Question:** What is the Windows API call used to queue an APC function?

*Answer:* 

     QueueUserAPC

**Question:** Can the void function pointer be used on a remote process? (y/n)
...
**Question:** What alternative Windows API call was used by TrickBot to create a new user thread?

*Answer:* 

     RtlCreateUserThread

**Question:** Was the injection techniques employed by TrickBot reflective? (y/n)

*Answer:* 

     y

**Question:** What function name was used to manually write hooks?
