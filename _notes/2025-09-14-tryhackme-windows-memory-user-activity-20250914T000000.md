---
layout: post
title: "TryHackMe | Windows Memory & User Activity"
date: 2025-09-14
tags: ["tryhackme"]
categories: [tryhackme]
hubs: "TryHackMe/Advanced Endpoint Investigations/Memory Analysis"
identifier: "20250914T000000"
source_urls: "https://tryhackme.com/room/windowsmemoryanduseractivity"
...
**Question:** Which plugin should be used to identify user login sessions from memory?

*Answer:* 

     windows.sessions

**Question:** Which user was logged into a console session when WINWORD.EXE and updater.exe were executed?

*Answer:* 

     DESKTOP-3NMNM0H/operator

**Question:** According to the UserAssist data, which executable related to command-line activity was launched via a shortcut?

*Answer:* 

     cmd.exe

**Question:** Which Volatility 3 plugin reveals evidence of programs launched by a user through the graphical interface?
...
**Question:** What file was passed to WINWORD.EXE?

*Answer:* 

     cv-resume-test.docm

**Question:** What is the name of the Volatility3 plugin that extracts open files, registry keys, and kernel objects from process handle tables?

*Answer:* 

     windows.handles

**Question:** What is the full device path where the.docm file was found open in WINWORD.EXE’s memory space?

*Answer:* 

     C:\Users\operator\Documents\cv-resume-test.docm

**Question:** What Windows command-line switch was used to open WINWORD.EXE in a new instance?
...
**Question:** What command did we use to confirm that the dumped .dat file is a Microsoft Word document?

*Answer:* 

     file

**Question:** According to the olevba output, what is the name of the file downloaded and executed by the macro?

*Answer:* 

     pdfupdater.exe

**Question:** What is the full URL hardcoded in the macro for downloading the executable?
