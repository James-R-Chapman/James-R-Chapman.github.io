...
identifier: "20250428T000003"
source_id: "e4af9ff1-5784-4b50-a9b0-3e4347fb99d4"
source_urls: "(https://tryhackme.com/room/sessionmanagement)"
source_path: "Web Application Pentesting/Authentication/20250428T000003--session-management__tryhackme.md"
---
...
**Question:** I am ready to learn about session management!
...
**Question:** Which state in the session management lifecycle deals with user's pressing the logout button?

*Answer:* 

     Session Termination

**Question:** Which state in the session management lifecycle deals with user's providing their credentials?

*Answer:* 

     Session Creation

**Question:** Which state in the session management lifecycle deals with user's actions performed after authentication?

*Answer:* 

     Session Tracking

**Question:** Which state in the session management lifecycle deals with user's that forget to log out of the application?
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1722529402239.png)
...
**Question:** What is the name of the process in the IAAA model that would be responsible for tracking your actions and logging them?

*Answer:* 

     Accountability

**Question:** What is the name of the process in the IAAA model that would be responsible for granting you a session value?

*Answer:* 

     Authentication

**Question:** What is the name of the process in the IAAA model that would be responsible for verifying that you have the relevant permissions to perform an action?
...
**Question:** What cookie attribute can be used to ensure that the cookie is only transmitted via secure HTTPS channels?

*Answer:* 

     secure

**Question:** What HTTP header is used in the response to inform the browser that a cookie is being sent?

*Answer:* 

     Set-Cookie

**Question:** What HTTP header is often used in requests to indicate the transmission of a JWT?
...
**Question:** What phase of the session management lifecycle would be vulnerable if you could predict what the value of a session would be?

*Answer:* 

     Session Creation

**Question:** What phase of the session management lifecycle would be vulnerable if you don't have the ability to flush a threat actor's access to your session?

*Answer:* 

     Session Termination

**Question:** What phase of the session management lifecycle would be vulnerable if there wasn't sufficient information to piece together what happened during an incident?

*Answer:* 

     Session Tracking

**Question:** What phase of the session management lifecycle would be vulnerable if
the session value itself was transmitted through an insecure redirect?
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1722450848675.png)
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1722451429592.png)
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1722451429583.png)
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1722451873193.png)
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1722451873192.png)
...
![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1722452082078.png)
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1722452094296.png)
...
![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1722452255723.png)
...
![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1722454261803.png)

Let's play around by updating our userRole from student to lecturer and refreshing the page:

![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/6093e17fa004d20049b6933e-1722454362144.png)
...
The initial token values that are loaded post-authentication dictate the visible information
 ...
 Users can forcibly terminate their session
   Session Termination
 Sessions are terminated server-side but reusing an old session leads to an internal server error  Given all of this information, we would already report the following vulnerabilities on a security assessment:
...
**Question:** What is the username of the student with the name X?

*Answer:* 

     THM{Got.the.User}

**Question:** How many lecturers are registered on the application?

*Answer:* 

     1

**Question:** Excluding the unauthenticated user, how many roles does the application have?

*Answer:* 

     3

**Question:** How many test attempts in total have been performed on the application?

*Answer:* 

     4

**Question:** What is the highest score that student1 has achieved on a test?

*Answer:* 

     3

**Question:** What is the sequence of correct answers for the Database Types test? (Format y=yes and n=no, separated by commas)
...
**Question:** I understand the session management lifecycle and how to secure it!
