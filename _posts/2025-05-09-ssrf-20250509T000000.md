...
identifier: "20250509T000000"
source_id: "d8e3a534-4634-432c-bda4-5e827397c031"
source_urls: "(https://tryhackme.com/room/ssrfhr)"
source_path: "Web Application Pentesting/Advanced Server-Side Attacks/20250509T000000--ssrf__tryhackme.md"
---
...
Start MachineThe landscape of web attacks constantly evolves, with threat actors devising sophisticated methods to compromise systems. As each day passes, the expansion of web-based threats warrants the need for **robust cyber security measures**  to counter the ever-advancing tactics employed by malicious actors. In this room, we will discuss a similar attack known as **Server Side Request Forgery (SSRF)** .
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/1910451b5490725491ba1f80e49ed8ed.svg)
...
**Question:** I can access the HRMS website.
...
**Data Exposure** As explained earlier, cybercriminals can gain unauthorised access by tampering with requests on behalf of the vulnerable web application to gain access to sensitive data hosted in the internal network.
...
**Question:** What is the average weighted impact for the SSRF vulnerability as per the OWASP Top 10?
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/07aeec8ece2fdc0a25ab67b527e35a47.png)
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/08f69d021a9f881f75749e0ce21ae08f.png)
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/8566f87e51f767f1bdfde449ac1018f1.png)
...
**Question:** What is the username for the HRMS login panel?

*Answer:* 

     hrmsadmin

**Question:** What is the password for the HRMS login panel?

*Answer:* 

     hrmsadmin@123

**Question:** What is the admin URL as per the config file?

*Answer:* 

     http://192.168.2.10/admin.php

**Question:** What is the flag value after successfully logging in to the HRMS web panel?
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/79c36e256f8be882f268675b1188b231.png)
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/ec6b8913193b20e30914d151620c3c4b.png)
...
![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/0123917ba4d9d0f89131a586bdaf44e9.png)
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/9457320f0396c8ee6da80e44623c9212.png)

- Once you update the value, choose the `Salary` option from the `Select Category` dropdown.

![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/676320914b2d5c7c61896d634f400b95.png)

- Here we go; we got access to the admin panel that was earlier inaccessible from the same IP.

![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/4713b3b463183dec150b81337e4d76f1.png)

### **Answer the questions below**

**Question:** Is accessing non-routable addresses possible if a server is vulnerable to SSRF (yea/nay)?
...
![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/0ef2a2a8940fb66215b3c543e2d89134.png)
...
![Image 12](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/8f499d3348f74b47f9f647a63041ae81.png)
...
**Question:** Does Out-of-band SSRF always include a technique in which an attacker always receives direct responses from the server (yea/nay)?

*Answer:* 

     nay

**Question:** What is the value for Virtual Directory Support on the PHP server per the logged data?

*Answer:* 

     disabled

**Question:** What is the value of the PHP Extension Build on the server?

*Answer:* 

     API20190902,NTS

**Question:** Which type of SSRF doesn't give us a direct response or feedback?
...
![Image 13](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/57fae798d14a3defe4c057d3926dd49d.png)
...
![Image 14](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/1254a5139518aff6b8d898889e4cde3f.png)
...
![Image 15](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/580c0061fcddddc03dfe7ecb168d452b.png)
...
**Question:** What is the flag value after loading a big image exceeding 100KB?
...
![Image 16](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/24147651267eedd828e4c103b84795d9.svg)
...
**Question:** Which of the following is the suggested approach while handling trusted URLs? Write the correct option only.a) Filter out disallowed URLsb) Maintaining an allowlist of trusted URLs

*Answer:* 

     b

**Question:** Since SSRF mainly exploits server-side requests, is it optional to sanitise the input URLs or parameters (yea/nay)?
...
In this course, we've covered the details of SSRF while shedding light on basic, blind, and time-based techniques. The course aimed at providing you with a comprehensive understanding of this vulnerability within web applications through hands-on exercises and daily-life scenarios. Moreover, we have also discussed some automated and manual tools to detect SSRF and remedial measures to protect from the vulnerability.
