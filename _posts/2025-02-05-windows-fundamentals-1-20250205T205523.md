...
source_id: "d20606b1-0881-4aa5-bbf5-416c71326978"
source_path: "Windows Exploitation Basic/20250205T205523--windows-fundamentals-1__tryhackme.md"
---
...
![Image 2](https://assets.tryhackme.com/additional/win-fun1/win-desktop2.png)
...
![Image 3](https://assets.tryhackme.com/additional/win-fun1/win-desktop-menu.png)
...
![Image 4](https://assets.tryhackme.com/additional/win-fun1/win-desktop-setdisplay.png)

**Note**: In a Remote Desktop session, some of the display settings will be disabled.

![Image 5](https://assets.tryhackme.com/additional/win-fun1/win-display-settings.png)

You can also change the wallpaper by selecting **Personalize**.

![Image 6](https://assets.tryhackme.com/additional/win-fun1/win-desktop-personalize.png)

Under Personalize, you can change the background image to the Desktop, change fonts, themes, color scheme, etc.

![Image 7](https://assets.tryhackme.com/additional/win-fun1/win-personalize-settings.png)
...
![Image 8](https://assets.tryhackme.com/additional/win-fun1/win-start-menu.png)
...
![Image 9](https://assets.tryhackme.com/additional/win-fun1/win-start-hamburger.png)
...
![Image 10](https://assets.tryhackme.com/additional/win-fun1/win-start-programs.png)
...
![Image 11](https://assets.tryhackme.com/additional/win-fun1/win-start-grid.png)
...
![Image 12](https://assets.tryhackme.com/additional/win-fun1/win-start-tile.png)
...
![Image 13](https://assets.tryhackme.com/additional/win-fun1/win-start-pin.png)

![Image 14](https://assets.tryhackme.com/additional/win-fun1/win-start-pin2.png)
...
![Image 15](https://assets.tryhackme.com/additional/win-fun1/win-taskbar1.png)

Any apps/programs, folders, files, etc., that you open/start will appear in the taskbar.

![Image 16](https://assets.tryhackme.com/additional/win-fun1/win-taskbar-chrome.png)
...
![Image 17](https://assets.tryhackme.com/additional/win-fun1/win-taskbar-settings.png)

From there, scroll down to the Notification Area section to make changes.

![Image 18](https://assets.tryhackme.com/additional/win-fun1/win-taskbar-notifarea.png)
...
![Image 19](https://assets.tryhackme.com/additional/win-fun1/win-file-system.gif)
...
![Image 20](https://assets.tryhackme.com/additional/win-fun1/ntfs-permissions1.png)
...
![Image 21](https://assets.tryhackme.com/additional/win-fun1/windows-folder-permissions.png)
...
![Image 22](https://assets.tryhackme.com/additional/win-fun1/windows-folder.png)

One of the many folders is **System32**.

![Image 23](https://assets.tryhackme.com/additional/win-fun1/windows-system32.png)
...
![Image 24](https://assets.tryhackme.com/additional/win-fun1/win-other-user1.png)

If you click on it, a Settings window should now appear. See below.

![Image 25](https://assets.tryhackme.com/additional/win-fun1/win-other-user.png)
...
![Image 26](https://assets.tryhackme.com/additional/win-fun1/win-other-user2.png)
...
![Image 27](https://assets.tryhackme.com/additional/win-fun1/win-other-user3.png)
...
![Image 28](https://assets.tryhackme.com/additional/win-fun1/win-profile-service.png)

Once logged in, the user will see a dialog box similar to the one below (again), indicating that the profile is in creation.

![Image 29](https://assets.tryhackme.com/additional/win-fun1/win-profile-service2.png)
...
![Image 30](https://assets.tryhackme.com/additional/win-fun1/win-lusrmgr.gif)
...
![Image 31](https://assets.tryhackme.com/additional/win-fun1/win-wireshark.png)
...
![Image 32](https://assets.tryhackme.com/additional/win-fun1/win-wireshark.png)

This shield icon is an indicator that UAC will prompt to allow higher-level privileges to install the program.

![Image 33](https://assets.tryhackme.com/additional/win-fun1/win-wireshark2.png)
...
![Image 34](https://assets.tryhackme.com/additional/win-fun1/win-uac.png)
...
![Image 35](https://assets.tryhackme.com/additional/win-fun1/win-settings.png)

**Control Panel**:

![Image 36](https://assets.tryhackme.com/additional/win-fun1/win-control-panel.png)
...
![Image 37](https://assets.tryhackme.com/additional/win-fun1/win-settings-cp.png)
...
![Image 38](https://assets.tryhackme.com/additional/win-fun1/win-change-adapter1.png)

Notice that the next window that pops up is from the Control Panel.

![Image 39](https://assets.tryhackme.com/additional/win-fun1/win-change-adapter2.png)
...
![Image 40](https://assets.tryhackme.com/additional/win-fun1/win-change-wallpaper.png)

If we click on the Best match, a window to the Settings menu appears to make changes to the wallpaper.

![Image 41](https://assets.tryhackme.com/additional/win-fun1/win-change-wallpaper2.png)
...
![Image 42](https://assets.tryhackme.com/additional/win-fun1/win-task-manager.png)

Task Manager will open in Simple View and won't show much information.

![Image 43](https://assets.tryhackme.com/additional/win-fun1/win-task-manager2.png)

Click on `More details`, and the view changes.

![Image 44](https://assets.tryhackme.com/additional/win-fun1/win-task-manager3.png)
...
**Question:** Read above and terminate the Windows machine you deployed in this room.
