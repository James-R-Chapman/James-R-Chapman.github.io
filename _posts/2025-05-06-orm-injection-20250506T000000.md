...
source_id: "731cf756-e1d9-4f98-893b-ff0d3d9a2a5d"
source_urls: "(https://tryhackme.com/room/orminjection)"
source_path: "Web Application Pentesting/Injection Attacks/20250506T000000--orm-injection__tryhackme.md"
---
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1718912807353)
...
**Question:** Which of the following is NOT a feature of ORM?a) Reducing boilerplate codeb) Increasing productivityc) Increase attack surface due to direct interface with the databased) Ensuring consistency
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1719390696224)
...
Level of injection
Targets raw SQL queries directly
Targets the ORM framework's query construction
Complexity
More straightforward, as it manipulates raw SQL
Requires understanding of ORM internals and methods
Detection
Easier to detect with traditional WAFs and query logs
Harder to detect, as payloads are within ORM methods
Mitigation
Use of prepared statements, parameterised queries, input validation
Proper ORM configuration, application-level input validation, ORM features enforcing query safety
...
**Question:** What is the method used in our Laravel code snippet to define the structure of the users table?
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1719390755189)
 ...
 **Framework** **ORM Library**  **Common Vulnerable Methods** Laravel
Eloquent ORM
`whereRaw(), DB::raw()`
Ruby on Rails
Active Record
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1719298104631)
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1719298337669)
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1718480201167)
...
## Task 5 | ORM Injection - Weak Implementation

In this task, we will explore how an attacker can exploit ORM vulnerabilities when the ORM is weakly implemented. To start, revisit the website at [https://LAB_WEB_URL.p.thmlabs.com](https://lab_web_url.p.thmlabs.com/), where we have our two input fields that accept email input.

![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1719303122392)
...
This query will always return all user records because the condition '1'='1' is perpetually true.
 ...
 ![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1718912926278)
...
![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1719304413178)
...
Now, try using the same malicious payload `1' OR '1'='1` with the secure implementation. Visit the website at [https://LAB_WEB_URL.p.thmlabs.com](https://lab_web_url.p.thmlabs.com/) and enter the payload in the **Email (Secure)**  input field. When you submit this input, you will notice that the application does not break or return all user data. Instead, it behaves as expected, either finding no user with that email or returning the appropriate user data if a valid email is provided, as shown below:

![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1719304704357)
...
To demonstrate this vulnerability, you can access the machine at [https://LAB_WEB_URL.p.thmlabs.com/query_users?sort=name](https://lab_web_url.p.thmlabs.com/query_users?sort=name). This endpoint allows getting the top users sorted by the `name` column via the `sort` parameter.

![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1719171806193)
...
![Image 12](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1719479019501)
...
![Image 14](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1718912983084)
...
**Question:** Which side should input validation be carried out? Write the correct option only.a) Clientb) Server c) Both Server and Client d) None
