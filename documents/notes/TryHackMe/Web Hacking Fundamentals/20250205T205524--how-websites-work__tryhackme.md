...
hubs: "TryHackMe/Web Hacking Fundamentals"
id: 52b4040f-85a6-4488-9ef3-0fb03583f30b
---

### Web Hacking Fundamentals > How Websites Work

### [TryHackMe | How Websites Work](https://tryhackme.com/r/room/howwebsiteswork)
...
![Image 1](https://assets.tryhackme.com/additional/how-websites-work/example_html.png)
...
**Question:** Let's play with some HTML! On the right-hand side, you should see a box that renders HTML - If you enter some HTML into the box and click the green "Render HTML Code" button, it will render your HTML on the page; you should see an image of some cats.
...
**Question:** Add the button HTML from this task that changes the element's text to "Button Clicked" on the editor on the right, update the code by clicking the "Render HTML+JS Code" button and then click the button.
...
![Image 2](https://assets.tryhackme.com/additional/how-websites-work/html_source.png)
...
When a user has control of how their input is displayed, they can submit HTML (or JavaScript) code, and the browser will use it on the page, allowing the user to control the page's appearance and functionality.
 ...
 ![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/5c549500924ec576f953d9fc/room-content/9c3ea7c9bcd06f125950e03aa814116a.svg)
