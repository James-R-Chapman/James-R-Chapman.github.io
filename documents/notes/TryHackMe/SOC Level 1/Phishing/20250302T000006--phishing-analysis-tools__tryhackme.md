...
tags:       ["tryhackme"]
identifier: "20250302T000006"
Hubs: "TryHackMe/SOC Level 1/Phishing"
urls: (https://tryhackme.com/room/phishingemails3tryoe)
id: eb242346-ce36-4eb3-bce7-10023d0abc22
---
...
![Image 1](https://assets.tryhackme.com/additional/phishing2/messageheader.png)
...
![Image 2](https://assets.tryhackme.com/additional/phishing2/mha.png)

Lastly, you can also use [mailheader.org](https://mailheader.org/).

![Image 3](https://assets.tryhackme.com/additional/phishing2/mailheader.png)
...
![Image 4](https://assets.tryhackme.com/additional/phishing2/ipinfo.png)
...
![Image 5](https://assets.tryhackme.com/additional/phishing2/urlscan.png)
...
![Image 6](https://assets.tryhackme.com/additional/phishing2/talos.png)
...
![Image 7](https://assets.tryhackme.com/additional/phishing2/copy-link.png)
...
![Image 8](https://assets.tryhackme.com/additional/phishing2/url-extractor.png)

The extracted URLs are visible in **Step 3** .

![Image 9](https://assets.tryhackme.com/additional/phishing2/url-extractor-2.png)

You may also use [CyberChef](https://gchq.github.io/CyberChef/) to extract URLs with the Extract URLs recipe.

![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/a31606afb772b8f87eebf0ff59f00fce.png)
...
![Image 11](https://assets.tryhackme.com/additional/phishing2/save-attachment.png)
...
![Image 12](https://assets.tryhackme.com/additional/phishing2/talos-file-rep.png)

![Image 13](https://assets.tryhackme.com/additional/phishing2/talos-file-rep-2.png)
...
![Image 14](https://assets.tryhackme.com/additional/phishing2/virustotal.png)

![Image 15](https://assets.tryhackme.com/additional/phishing2/virustotal-2.png)
...
![Image 16](https://assets.tryhackme.com/additional/phishing2/any-run.png)
...
![Image 17](https://assets.tryhackme.com/additional/phishing2/hybrid-analysis.png)
...
![Image 18](https://assets.tryhackme.com/additional/phishing2/joe-security.png)
...
![Image 19](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/0dcc25c992ddfdfc60532f6fb9416a70.png)
...
![Image 20](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/9665b8957923a892e721a0e02e42ea9f.png)

Below is a snippet of Hop 1 of 6 (SMTP relays).

![Image 21](https://assets.tryhackme.com/additional/phishing2/phish-smtp.png)
...
![Image 22](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/94366a297a0abb9b7f680e006c421b45.png)

HTML view:

![Image 23](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/e5eb24859d263b8d233f52c1502aaed4.png)
...
![Image 24](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/a737376ca1243a926f7a41a765cb7a1e.png)

The left pane will show information about the attachment. This particular malicious email has a zip file.

![Image 25](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/685f9bb5291973038d55aca7c09ffd1e.png)
...
![Image 26](https://assets.tryhackme.com/additional/phishing2/phish-options.png)

Let's look at the Strings output.

![Image 27](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/e1f11b62dbd9ed415177bdbc44a13d2d.png)

Next, let's look at the information from VirusTotal.

![Image 28](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/5c0556b15a803638a2d289915edc8946.png)
...
![Image 29](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/31728d39e79f36340ab8bcdd740940d6.png)

The attachment file name and file hashes will be marked as malicious. Next, click on **Resolve** .

![Image 30](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/64c5e32e65919e17e352161594fbb627.png)

In the next screen, an analyst can mark the email based on dropdown selections. Refer to the GIF below.

![Image 31](https://assets.tryhackme.com/additional/phishing2/resolve-case.gif)
...
**Question:** Look at the Strings output. What is the name of the EXE file?
...
Start MachineScenario: You are a Level 1 SOC Analyst. Several suspicious emails have been forwarded to you from other coworkers. You must obtain details from each email for your team to implement the appropriate rules to prevent colleagues from receiving additional spam/phishing emails.
...
![Image 32](https://assets.tryhackme.com/additional/phishing2/p3-split-view.png)

### **Answer the questions below**

**Question:** What brand was this email tailored to impersonate?

*Answer:* 

     Netflix

**Question:** What is the From email address?

*Answer:* 

     N e t f I i x <JGQ47wazXe1xYVBrkeDg-JOg7ODDQwWdR@JOg7ODDQwWdR-yVkCaBkTNp.gogolecloud.com>

**Question:** What is the originating IP? Defang the IP address.

*Answer:* 

     209[.]85[.]167[.]226

**Question:** From what you can gather, what do you think will be a domain of interest? Defang the domain.

*Answer:* 

     etekno[.]xyz

**Question:** What is the shortened URL? Defang the URL.
...
**Question:** What does AnyRun classify this email as?

*Answer:* 

     Suspicious activity

**Question:** What is the name of the PDF file?

*Answer:* 

     Payment-updateid.pdf

**Question:** What is the SHA 256 hash for the PDF file?

*Answer:* 

     cc6f1a04b10bcb168aeec8d870b97bd7c20fc161e8310b5bce1af8ed420e2c24

**Question:** What two IP addresses are classified as malicious? Defang the IP addresses. (answer: IP_ADDR,IP_ADDR)

*Answer:* 

     2[.]16[.]107[.]24,2[.]16[.]107[.]83

**Question:** What Windows process was flagged as Potentially Bad Traffic?
...
**Question:** What is this analysis classified as?

*Answer:* 

     Malicious activity

**Question:** What is the name of the Excel file?

*Answer:* 

     CBJ200620039539.xlsx

**Question:** What is the SHA 256 hash for the file?

*Answer:* 

     5f94a66e0ce78d17afc2dd27fc17b44b3ffc13ac5f42d3ad6a5dcfb36715f3eb

**Question:** What domains are listed as malicious? Defang the URLs & submit answers in alphabetical order. (answer: URL1,URL2,URL3)

*Answer:* 

     biz9holdings[.]com,findresults[.]site,ww38[.]findresults[.]site

**Question:** What IP addresses are listed as malicious? Defang the IP addresses & submit answers from lowest to highest. (answer: IP1,IP2,IP3)
