...
date:       2025-02-07T19:00:00-05:00
tags:       ["tryhackme"]
identifier: "20250207T190000"
Hubs: "TryHackMe/SOC Level 1/Endpoint Security Monitoring"
urls: '(https://tryhackme.com/room/introtoendpointsecurity)'
id: 1d37ac17-f82f-4429-8170-36cb61996542
---
# Contents
...
- [Task 1 | Room Introduction](#task-1--room-introduction)
...
Answer the questions belowI have read the introduction task.Correct Answer

### **Answer the questions below**

**Question:** I have read the introduction task.
...
![Image 1](https://assets.tryhackme.com/additional/windows-processes/taskmanager-7.png)
...
![Image 2](https://assets.tryhackme.com/additional/sysinternals/tcpview0.png)
...
![Image 3](https://assets.tryhackme.com/additional/sysinternals/procexp-svchost-services.png)
...
Answer the questions belowWhat is the normal parent process of services.exe?Correct AnswerWhat is the name of the network utility tool introduced in this task?
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/5dbea226085ab6182a2ee0f7/room-content/d8e5eb05be195a17c96ff607fa75ef72.png)
...
![Image 5](https://i.imgur.com/HtS0AOx.png)
...
![Image 6](https://assets.tryhackme.com/additional/osquery/kolide_query_filter2.png)
...
![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/6c2d68f59482de413940f2d11913fae1.gif)

To experience Wazuh in action, you may refer to the [Wazuh Room](https://tryhackme.com/room/wazuhct).

Answer the questions belowWhere do the Windows Event logs (.evtx files) typically reside?Correct AnswerProvide the command used to enter OSQuery CLI.

Correct AnswerWhat does EDR mean? Provide the answer in lowercase.
...
**Baseline** **Unusual Activity** The organization's employees are in London, and the regular working hours are between 9 AM and 6 PM.A user has authenticated via VPN connecting from Singapore at 3 AM.A single workstation is assigned to each employee.A user has attempted to authenticate to multiple workstations.Employees can only access selected websites on their workstations, such as OneDrive, SharePoint, and other O365 applications.A user has uploaded a 3GB file on Google Drive.Only selected applications are installed on workstations, mainly Microsoft Applications such as Microsoft Word, Excel, Teams, OneDrive and Google Chrome.A process named firefox.exe has been observed running on multiple employee workstations.Any event could be a needle in a haystack without a good overview of regular activity.
...
Answer the questions belowClick on the green View Site button in this task to open the Static Site Lab and start investigating the threat by following the provided instructions.Correct AnswerProvide the flag for the simulated investigation activity.

Correct Answer

### **Answer the questions below**

**Question:** Click on the green View Site button in this task to open the Static Site Lab and start investigating the threat by following the provided instructions.
...
Answer the questions belowI have completed the Introduction to Endpoint Security Monitoring room.Complete

### **Answer the questions below**

**Question:** I have completed the Introduction to Endpoint Security Monitoring room.
