...
tags:       ["tryhackme"]
identifier: "20250212T000005"
Hubs: "TryHackMe/SOC Level 1/Endpoint Security Monitoring"
urls: (https://tryhackme.com/room/wazuhct)
id: b182288e-38bd-4639-9b74-2ae9844be997
---
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/4c008954c296fe1fbca005637af73ea1.png)

*We can see logs from three Agents being sent to the Wazuh server.*

Answer the questions belowWhen was Wazuh released?Correct AnswerWhat is the term that Wazuh calls a device that is being monitored for suspicious activity and potential security threats?

Correct AnswerLastly, what is the term for a device that is responsible for managing these devices?
...
Start Machine[Connect ](https://tryhackme.com/access)to the TryHackMe network and deploy the Wazuh management server attached to this task and wait a **minimum of five minutes**  before visiting the Wazuh server on [HTTP://MACHINE_IP](http://machine_ip/).
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/e072a26a84886784f231585294f763dd.gif)
...
Answer the questions belowLogin to the Wazuh management server on [HTTP://MACHINE_IP](http://machine_ip/)[](https://machine_ip.p.thmlabs.com/) before proceeding with this room's tasks.

Correct Answer

### **Answer the questions below**

**Question:** Login to the Wazuh management server on HTTP://MACHINE_IP before proceeding with this room's tasks.
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/561a60f3973c417098e4381bc50f9252.png)
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/5729622f750cdd7185c094ad09ce70f8.png)

**Installing the Wazuh agent on Debian/Ubuntu:**

![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/e50f510af70b7cd247e5623cbd5f7e31.png)

Answer the questions belowEnsure that you are logged in to the Wazuh management server on [HTTPS://MACHINE_IP](https://machine_ip/)Correct AnswerNavigate to the "Agents" tab by pressing **Wazuh**  -> **Agents**

Correct AnswerHow many agents does this Wazuh management server manage?

Correct AnswerWhat are the status of the agents managed by this Wazuh management server?

Correct Answer

### **Answer the questions below**

**Question:** Ensure that you are logged in to the Wazuh management server on HTTPS://MACHINE_IP

*Answer:* 

     No answer needed

**Question:** Navigate to the "Agents" tab by pressing Wazuh -> Agents
...
![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/1907912f601690e47d5e11d031461f4b.png)
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/06c4394959f434bffd04a4a6618b576b.png)
...
![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/55456a88291bf69e44a15e5a742faf1e.png)
...
![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/3a195f897882eee1b3151a3b5b167054.gif)

 

Answer the questions belowEnsure that you are logged in to the Wazuh management server on [HTTP://MACHINE_IP](http://machine_ip/)

Correct AnswerNavigate to the Agents tab by pressing **Wazuh**  -> **Agents**  like so

Correct AnswerSelect the agent named "**AGENT-001** "

Correct AnswerHow many "Security Event" alerts have been generated by the agent "AGENT-001"?
...
**Question:** Ensure that you are logged in to the Wazuh management server on HTTP://MACHINE_IP

*Answer:* 

     No answer needed

**Question:** Navigate to the Agents tab by pressing Wazuh -> Agents like so

*Answer:* 

     No answer needed

**Question:** Select the agent named "AGENT-001"

*Answer:* 

     No answer needed

**Question:** How many "Security Event" alerts have been generated by the agent "AGENT-001"?Note: You will need to make sure that your time range includes the 11th of March 2022
...
![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/8780dc7af8c03529235e8e89bc23ae7c.png)
...
![Image 12](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/ac6454463eb96d632b951035e7599253.png)

Answer the questions belowEnsure that you are logged in to the Wazuh management server on [MACHINE_IP](https://tryhackme.com/room/MACHINE_IP%20target=)

Correct AnswerNavigate to the "Modules" tab by pressing **Wazuh**  -> **Modules** and open the "Policy Management" module like so:

![Image 13](https://assets.tryhackme.com/additional/wazuh/navigate5.png)

Correct Answer

### **Answer the questions below**

**Question:** Ensure that you are logged in to the Wazuh management server on MACHINE_IP

*Answer:* 

     No answer needed

**Question:** Navigate to the "Modules" tab by pressing Wazuh -> Modules and open the "Policy Management" module like so:
...
![Image 14](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/17572a8abaac35f9e281c54a8b861836.gif)
...
**Field** **Value** **Description** agent.ip10.10.73.118This is the IP address of the agent that the alert was triggered on.agent.nameip-10-10-73-118This is the hostname of the agent that the alert was triggered on.rule.descriptionsshd: Attempt to login using a non-existent userThis field is a brief description of what the event is alerting to.rule.mitre.techniqueBrute-ForceThis field explains the MITRE technique that the alert pertains to.rule.mitre.idT1110This field is the MITRE ID of the alertrule.id5710This field is the ID assigned to the alert by Wazuh's rulesetlocation/var/log/auth.logThis field is the location of the file that the alert was generated from on the agent. In this example, it is the authentication log on the linux agent.
...
![Image 15](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/b5ecf8381077df9822de51cd6e81f8ff.gif)
...
![Image 16](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/6c2d68f59482de413940f2d11913fae1.gif)

Answer the questions belowEnsure that you are logged in to the Wazuh management server on [HTTP://MACHINE_IP](http://machine_ip/)

Correct AnswerNavigate to the "Management" tab by pressing Wazuh -> **Management** and open the "Rules" module like so:

![Image 17](https://assets.tryhackme.com/additional/wazuh/rules2.png)
...
**Question:** Navigate to the "Management" tab by pressing Wazuh -> Management and open the "Rules" module like so:
...
![Image 18](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/8a1cf21e3a8fa4d7e42c8395a50973e6.png)

![Image 19]()

 ![Image 20](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/e1605655cc49dd89016b1bdc87561561.png)

 ![Image 21](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/ba0799f89ee450cc9646b169fc1927b1.png)
 ...
 ![Image 22](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/8a05b23adeb562db0e3ed27b1ff31dca.png)

 ![Image 23](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/3b3bca59a5fc8d0de3b06d872838c70d.png)
 ...
 ![Image 24](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/a41077ba6bd769954ff3c353ec33b890.png)
 ...
 ![Image 25](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/ea9e6fe95bb44847fc17c4096a1e8fe5.png)
...
```
 ...
 ![Image 26](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/c6f7ce784d60c25cfcf58b36fa5be0f0.png)
 ...
 ![Image 27](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/70dbe7115a64426e5648a169173a5d24.gif)
...
```
 ...
 Answer the questions belowWhat is the name of the tool that we can use to monitor system events?Correct AnswerWhat standard application on Windows do these system events get recorded to?
...
Answer the questions belowWhat is the full file path to the rules located on a Wazuh management server?Correct Answer
...
We can then use the log collector module on a Wazuh agent to read this log file and send it to the Wazuh management server for processing.
 ...
 First, we will need to install the `auditd `package and an `auditd `plugin. This may already be installed on your system; however, let’s install it to make sure. Let’s run the command `sudo apt-get install auditd
audispd-plugins` and enable this service to run currently as well as on boot.`sudo
systemctl enable auditd.service` & `sudo systemctl start auditd.service`
...
You can extend this to monitor commands such as `tcpdump`, `netcat`, or *catting*  files such as */etc/passwd* , which are all hallmarks of a breach.
 ...
 For this task, we will need to open this *audit.rules*  file and append our rule ourselves. First, let’s edit the file using` sudo nano
/etc/audit/rules.d/audit.rules` and appending `-a exit,always -F arch=64 -F
euid=0 -S execve -k audit-wazuh-c`
...
![Image 28](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/16f9a29cff90a5c7baefa980922f4066.png)

Answer the questions belowWhat application do we use on Linux to monitor events such as command execution?Correct AnswerWhat is the full path & filename for where the aforementioned application stores rules?
...
![Image 29](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/676b0bc423d8692a96cca58f5d86605a.png)
...
![Image 30](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/e3daa0e68fe454de9e61bde5cd87c8a1.gif)
...
Answer the questions belowWhat is the name of the standard Linux tool that we can use to make requests to the Wazuh management server?Correct AnswerWhat HTTP method would we use to retrieve information for a Wazuh management server API?

Correct AnswerWhat HTTP method would we use to perform an action on a Wazuh management server API?

Correct AnswerNavigate to Wazuh's API console.

Correct AnswerHintUse the API console to find the Wazuh server's version.
...
**Question:** Navigate to Wazuh's API console.

*Answer:* 

     No answer needed

**Question:** Use the API console to find the Wazuh server's version.Note: You will need to add the "v" prefix to the number for this answer. For example v1.2.3
...
![Image 31](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/41d15d504f407acf744fdfdd00b152a9.png)

****

Now, if there have been alerts within the last 24 hours, I can generate a report like so:

![Image 32](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/2710a93265a303595e8aefadf498f400.png)
...
![Image 33](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/d5f90046e283c983f1f1ae0a6662c990.png)
...
![Image 34](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/e6ea3d0724fe2cb241dc3c8a4ba08363.png)

Answer the questions belowUse Wazuh's "Report" feature to generate a report of an agent.

Correct AnswerNavigate to the [Wazuh "Report" dashboard](https://machine_ip/app/wazuh#/manager/?tab=reporting)

Correct AnswerAnalyse the report. What is the name of the agent that has generated the most alerts?

Correct Answer

### **Answer the questions below**

**Question:** Use Wazuh's "Report" feature to generate a report of an agent.

*Answer:* 

     No answer needed

**Question:** Navigate to the Wazuh "Report" dashboard
...
![Image 35](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/b3915d96928cd3999a652155e21a88f2.png)
...
![Image 36](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/cdea39d294694de9ae762e086acc1e81.png)
...
![Image 37](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/c3e72b11a3b6fc4acae20858c928e28e.png)

Answer the questions belowI've imported the sample data!Correct AnswerI have played around with the sample data.

Complete

### **Answer the questions below**

**Question:** I've imported the sample data!

*Answer:* 

     No answer needed

**Question:** I have played around with the sample data.
