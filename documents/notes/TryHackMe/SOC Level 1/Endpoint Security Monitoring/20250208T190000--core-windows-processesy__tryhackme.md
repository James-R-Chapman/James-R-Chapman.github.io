---
title:      "Core Windows Processesy"
date:       2025-02-08T19:00:00-05:00
tags:       ["tryhackme"]
identifier: "20250208T190000"
Hubs: "TryHackMe/SOC Level 1/Endpoint Security Monitoring"
urls: "(https://tryhackme.com/room/btwindowsinternals)"
id: f06781a6-4d4a-44e1-8fce-21f3196982b2
---
...
Answer the questions belowI've read the intro and deployed the attached virtual machine.Correct Answer

### **Answer the questions below**

**Question:** I've read the intro and deployed the attached virtual machine.
...
![Image 1](https://assets.tryhackme.com/additional/windows-processes/taskmanager.png)

If you don't have any explicitly opened apps, you should see the same message as shown below.

![Image 2](https://assets.tryhackme.com/additional/windows-processes/taskmanager-2.png)

Weird. Not seeing much, eh? Within a Windows system, many processes are running. Click on `More details`.

![Image 3](https://assets.tryhackme.com/additional/windows-processes/taskmanager-3.png)
...
![Image 4](https://assets.tryhackme.com/additional/windows-processes/taskmanager-4.png)

![Image 5](https://assets.tryhackme.com/additional/windows-processes/taskmanager-5.png)
...
![Image 6](https://assets.tryhackme.com/additional/windows-processes/taskmanager-6.png)
...
![Image 7](https://assets.tryhackme.com/additional/windows-processes/taskmanager-7.png)
...
![Image 8](https://assets.tryhackme.com/additional/windows-processes/taskmanager-8.png)
...
![Image 9](https://assets.tryhackme.com/additional/windows-processes/processhacker.png)

**Process Explorer**

![Image 10](https://assets.tryhackme.com/additional/windows-processes/process-explorer.png)
...
Answer the questions belowOn to the next task...Correct Answer

### **Answer the questions below**

**Question:** On to the next task...
...
![Image 11](https://assets.tryhackme.com/additional/windows-processes/system.png)

**Image Path** : N/A**Parent Process** : None**Number of Instances** : One**User Account** : Local System**Start Time** : At boot time
The information is slightly different if we view the System properties using Process Hacker.

![Image 12](https://assets.tryhackme.com/additional/windows-processes/system2.png)
...
Answer the questions belowWhat PID should System always be?Correct Answer
...
![Image 13](https://assets.tryhackme.com/additional/windows-processes/smss-session0-tree.png)

![Image 14](https://assets.tryhackme.com/additional/windows-processes/smss-session0b.png)

Session 1 (csrss.exe & winlogon.exe)

![Image 15](https://assets.tryhackme.com/additional/windows-processes/smss-session1-tree.png)

![Image 16](https://assets.tryhackme.com/additional/windows-processes/smss-session1b.png)

Any other subsystem listed in the `Required` value of `HKLM\System\CurrentControlSet\Control\Session Manager\Subsystems` is also launched.

![Image 17](https://assets.tryhackme.com/additional/windows-processes/smss-registry.png)

SMSS is also responsible for creating environment variables, virtual memory paging files and starts winlogon.exe (the Windows Logon Manager).
What is normal?

![Image 18](https://assets.tryhackme.com/additional/windows-processes/smss.png)
...
Answer the questions belowAside from csrss.exe, what process does smss.exe spawn in Session 1?Correct AnswerHint
...
![Image 19](https://assets.tryhackme.com/additional/windows-processes/csrss-session0.png)

Session 1 (PID 512)

![Image 20](https://assets.tryhackme.com/additional/windows-processes/csrss-session1.png)
...
Answer the questions belowWhat was the process which had PID 384 and PID 488?Correct Answer
...
![Image 21](https://assets.tryhackme.com/additional/windows-processes/wininit-tree.png)
...
![Image 22](https://assets.tryhackme.com/additional/windows-processes/wininit.png)
...
Answer the questions belowWhich process might you not see running if Credential Guard is not enabled?Correct Answer
...
![Image 23](https://assets.tryhackme.com/additional/windows-processes/services-registry.png)
...
![Image 24](https://assets.tryhackme.com/additional/windows-processes/lastknowngood.png)
...
![Image 25](https://assets.tryhackme.com/additional/windows-processes/services-tree.png)

What is normal?

![Image 26](https://assets.tryhackme.com/additional/windows-processes/services.png)

![Image 27](https://assets.tryhackme.com/additional/windows-processes/services2.png)

**Image Path** : %SystemRoot%\System32\services.exe**Parent Process** : wininit.exe**Number of Instances** : One**User Account** : Local System**Start Time** : Within seconds of boot time
What is unusual?
...
Answer the questions belowHow many instances of services.exe should be running on a Windows system?Correct Answer
...
![Image 28](https://assets.tryhackme.com/additional/windows-processes/dcomlaunch.png)
...
![Image 29](https://assets.tryhackme.com/additional/windows-processes/servicedll.png)

To view this information from within Process Hacker, right-click the svchost.exe process. In this case, it will be PID 748.

![Image 30](https://assets.tryhackme.com/additional/windows-processes/dcomlaunch2.png)

Right-click the service and select Properties. Look at Service DLL.

![Image 31](https://assets.tryhackme.com/additional/windows-processes/dcomlaunch3.png)
...
![Image 32](https://assets.tryhackme.com/additional/windows-processes/shared-process.png)

Each will have a different value for ServiceDLL. Let's take LSM as an example and inspect the value for ServiceDLL.

![Image 33](https://assets.tryhackme.com/additional/windows-processes/lcm.png)

![Image 34](https://assets.tryhackme.com/additional/windows-processes/lcm2.png)
...
![Image 35](https://assets.tryhackme.com/additional/windows-processes/svchost.png)
...
Answer the questions belowWhat single letter parameter should always be visible in the **Command line** or **Binary path** ?Correct Answer
...
![Image 36](https://assets.tryhackme.com/additional/windows-processes/lsa.png)
...
![Image 37](https://assets.tryhackme.com/additional/windows-processes/lsass.png)

**Image Path** : %SystemRoot%\System32\lsass.exe**Parent Process** : wininit.exe**Number of Instances** : One**User Account** : Local System**Start Time** : Within seconds of boot time
What is unusual?
...
Answer the questions belowWhat is the parent process for LSASS?Correct Answer
...
![Image 38](https://assets.tryhackme.com/additional/windows-processes/winlogon-registry.png)
...
![Image 39](https://assets.tryhackme.com/additional/windows-processes/winlogon-tree.png)

What is normal?

![Image 40](https://assets.tryhackme.com/additional/windows-processes/winlogon1.png)

![Image 41](https://assets.tryhackme.com/additional/windows-processes/winlogon2.png)
...
Answer the questions belowWhat is the non-existent parent process for winlogon.exe?Correct Answer
...
![Image 42](https://assets.tryhackme.com/additional/windows-processes/explorer-tree.png)

What is normal?

![Image 43](https://assets.tryhackme.com/additional/windows-processes/explorer.png)

**Image Path** : %SystemRoot%\explorer.exe**Parent Process** : Created by userinit.exe and exits**Number of Instances** : One or more per interactively logged-in user**User Account** : Logged-in user(s)**Start Tim** e: First instance when the first interactive user logon session begins
What is unusual?
...
![Image 44](https://assets.tryhackme.com/additional/windows-processes/explorer-tcpip.png)

**Note** : The above image is the explorer.exe properties view from Process Explorer.Answer the questions belowWhat is the non-existent process for explorer.exe?Correct Answer
...
Answer the questions belowThanks for stopping by.Complete

### **Answer the questions below**

**Question:** Thanks for stopping by.
