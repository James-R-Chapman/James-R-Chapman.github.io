...
tags:       ["tryhackme"]
identifier: "20250212T000004"
Hubs: "TryHackMe/SOC Level 1/Endpoint Security Monitoring"
urls: (https://tryhackme.com/room/sysmon)
id: fb1fb291-c720-46ee-85d3-d312f3f437d7
---
...
![Image 1](https://wp.technologyreview.com/wp-content/uploads/2020/02/ms-securitylogostackedc-grayrgb-hero-copy-small-1.png)
...
Answer the questions belowComplete the prerequisites listed above and jump into task 2.Correct Answer

### **Answer the questions below**

**Question:** Complete the prerequisites listed above and jump into task 2.
...
Answer the questions belowRead the above and become familiar with the Sysmon Event IDs.Correct Answer

### **Answer the questions below**

**Question:** Read the above and become familiar with the Sysmon Event IDs.
...
Start MachineInstalling Sysmon
...
![Image 2](https://i.imgur.com/HtS0AOx.png)
...
Answer the questions belowDeploy the machine and start Sysmon. 
Correct Answer

### **Answer the questions below**

**Question:** Deploy the machine and start Sysmon.
...
Download Task FilesMalicious Activity Overview
...
Answer the questions belowRead the above and practice filtering events.Correct AnswerHow many event ID 3 events are in C:\Users\THM-Analyst\Desktop\Scenarios\Practice\Filtering.evtx?

Correct AnswerWhat is the UTC time created of the first network event in C:\Users\THM-Analyst\Desktop\Scenarios\Practice\Filtering.evtx?

Correct Answer

### **Answer the questions below**

**Question:** Read the above and practice filtering events.
...
Download Task FilesHunting Metasploit
...
![Image 5](https://i.imgur.com/1VkrpJ3.png)
...
Answer the questions belowRead the above and practice hunting Metasploit with the provided event file.Correct Answer

### **Answer the questions below**

**Question:** Read the above and practice hunting Metasploit with the provided event file.
...
Download Task FilesDetecting Mimikatz Overview
...
![Image 6](https://i.imgur.com/S0T3AHM.png)
...
Answer the questions belowRead the above and practice detecting Mimikatz with the provided evtx.

Correct Answer

### **Answer the questions below**

**Question:** Read the above and practice detecting Mimikatz with the provided evtx.
...
Download Task FilesHunting Malware Overview
...
![Image 7](https://i.imgur.com/h7NcexZ.png)
...
Answer the questions belowRead the Above and practice hunting rats and C2 servers with back connect ports. Correct Answer

### **Answer the questions below**

**Question:** Read the Above and practice hunting rats and C2 servers with back connect ports.
...
Download Task FilesPersistence Overview
...
![Image 8](https://i.imgur.com/cQNpkWR.png)
...
![Image 9](https://i.imgur.com/yhRxVrU.png)

![Image 10](https://i.imgur.com/zipqQIF.png)
...
![Image 11](https://i.imgur.com/NkvJNew.png)
...
![Image 12](https://i.imgur.com/d6hLTud.png)

Answer the questions belowRead the above and practice hunting persistence techniques.Correct Answer

### **Answer the questions below**

**Question:** Read the above and practice hunting persistence techniques.
...
Download Task FilesEvasion Techniques Overview
...
![Image 13](https://i.imgur.com/kuQrOwh.png)
...
![Image 14](https://i.imgur.com/R2cRHqa.png)
...
Answer the questions belowRead the above and practice detecting evasion techniquesCorrect Answer

### **Answer the questions below**

**Question:** Read the above and practice detecting evasion techniques
...
Download Task FilesEvent files used within this task have been sourced from the [EVTX-ATTACK-SAMPLES](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES/tree/master) and [SysmonResources](https://github.com/jymcheong/SysmonResources) Github repositories.
...
Answer the questions belowWhat is the full registry key of the USB device calling svchost.exe in Investigation 1? Correct AnswerWhat is the device name when being called by RawAccessRead in Investigation 1?

Correct AnswerWhat is the first exe the process executes in Investigation 1?

Correct AnswerWhat is the full path of the payload in Investigation 2?

Correct AnswerWhat is the full path of the file the payload masked itself as in Investigation 2?

Correct AnswerWhat signed binary executed the payload in Investigation 2?

Correct AnswerWhat is the IP of the adversary in Investigation 2?

Correct AnswerWhat back connect port is used in Investigation 2?

Correct AnswerWhat is the IP of the suspected adversary in Investigation 3.1?

Correct AnswerWhat is the hostname of the affected endpoint in Investigation 3.1?

Correct AnswerWhat is the hostname of the C2 server connecting to the endpoint in Investigation 3.1?

Correct AnswerWhere in the registry was the payload stored in Investigation 3.1?

Correct AnswerWhat PowerShell launch code was used to launch the payload in Investigation 3.1?

Correct AnswerWhat is the IP of the adversary in Investigation 3.2?

Correct AnswerWhat is the full path of the payload location in Investigation 3.2?

Correct AnswerWhat was the full command used to create the scheduled task in Investigation 3.2?

Correct AnswerWhat process was accessed by schtasks.exe that would be considered suspicious behavior in Investigation 3.2?

Correct AnswerWhat is the IP of the adversary in Investigation 4?

Correct AnswerWhat port is the adversary operating on in Investigation 4?

Correct AnswerWhat C2 is the adversary utilizing in Investigation 4?
