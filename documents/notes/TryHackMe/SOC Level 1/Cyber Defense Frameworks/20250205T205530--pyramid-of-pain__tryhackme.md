...
tags:       ["tryhackme"]
identifier: "20250205T205530"
hubs: "TryHackMe/SOC Level 1/Cyber Defense Frameworks"
id: 65a80ec3-e46a-4b8b-bdbe-f8118d1688a6
---

### SOC Level 1 > Cyber Defence Frameworks > Pyramid Of Pain

### [TryHackMe | Pyramid Of Pain](https://tryhackme.com/r/room/pyramidofpainax)
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/60c7fac321aca20049602d2b/room-content/b217b6aa2148826ef0e88ec28c2aa79e.png)
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/60c7fac321aca20049602d2b/room-content/8e9ad0b23f711036a023a9311dfa0b1d.png)
...
```
  ...
  Answer the questions belowAnalyse the report associated with the hash "b8ef959a9176aef07fdca8705254a163b50b49a17217a4ff0107487f59d4a35d" [here.](https://assets.tryhackme.com/additional/pyramidofpain/t3-virustotal.pdf) What is the filename of the sample?Correct AnswerHint
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/60c7fac321aca20049602d2b/room-content/86baaabb1df7d710dfc219762c4713e6.png)
...
Answer the questions belowRead the following[ report](https://assets.tryhackme.com/additional/pyramidofpain/task3-anyrun.pdf) to answer this question. What is the **first IP address**  the malicious process (**PID 1632** ) attempts to communicate with? Correct AnswerHintRead the following[ report](https://assets.tryhackme.com/additional/pyramidofpain/task3-anyrun.pdf) to answer this question. What is the **first domain name**  the malicious process ((PID 1632) attempts to communicate with?Correct AnswerHint
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/60c7fac321aca20049602d2b/room-content/efcc44de8368a8cc7d99148f560ae2fd.png)

![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/60c7fac321aca20049602d2b/room-content/03ad636820590525bdd91e28a04bbec1.png)

Can you spot anything malicious in the above screenshot? Now, compare it to the legitimate website view below:

![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/60c7fac321aca20049602d2b/room-content/7c4329f6d1d09a739097f818dc42e733.png)
...
You can see the actual website the shortened link is redirecting you to by appending "+" to it (see the examples below). Type the shortened URL in the address bar of the web browser and add the above characters to see the redirect URL. **** **NOTE: The examples of the shortened links below are non-existent.** 

![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/5c549500924ec576f953d9fc/room-content/78481d27921134df9daab358a42ff5d0.png)
...
![Image 8](https://assets.tryhackme.com/additional/pyramidofpain/t4/http%20requests.png)
...
![Image 9](https://assets.tryhackme.com/additional/pyramidofpain/t4/connections.png)
...
![Image 10](https://assets.tryhackme.com/additional/pyramidofpain/t4/dnsrequests.png)

 Answer the questions belowGo to [this report on app.any.run](https://app.any.run/tasks/a66178de-7596-4a05-945d-704dbf6b3b90) and provide the first **suspicious**  domain request you are seeing, you will be using this report to answer the remaining questions of this task.Correct AnswerWhat term refers to an address used to access websites?

Correct AnswerWhat type of attack uses Unicode characters in the domain name to imitate the a known domain?

Correct AnswerProvide the redirected website for the shortened URL using a preview: https://tinyurl.com/bw7t8p4uCorrect Answer

### **Answer the questions below**

**Question:** Go to this report on app.any.run and provide the first suspicious domain request you are seeing, you will be using this report to answer the remaining questions of this task.
...
![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/60c7fac321aca20049602d2b/room-content/6b91c7de5654b7f285991787cb3bb4fe.png)

**Suspicious events followed by opening a malicious application:**

![Image 12](https://tryhackme-images.s3.amazonaws.com/user-uploads/60c7fac321aca20049602d2b/room-content/6d742c9c22f99f30e3c8356ef7c36800.png)

****

**The files modified/dropped by the malicious actor:**

![Image 13](https://tryhackme-images.s3.amazonaws.com/user-uploads/5c549500924ec576f953d9fc/room-content/353235afb71be81d56fb079dc7111b15.png)

****

Answer the questions belowA security vendor has analysed the malicious sample for us. Review the report [here](https://assets.tryhackme.com/additional/pyramidofpain/task5-report.pdf) to answer the following questions.

Correct AnswerA process named **regidle.exe**  makes a POST request to an IP address based in the United States (US) on **port 8080** . What is the IP address?Correct AnswerHintThe actor drops a malicious executable (EXE). What is the name of this executable?

Correct AnswerHintLook at this [report](https://assets.tryhackme.com/additional/pyramidofpain/vtotal2.png) by Virustotal. How many vendors determine this host to be malicious?

Correct AnswerHint

### **Answer the questions below**

**Question:** A security vendor has analysed the malicious sample for us. Review the report here to answer the following questions.
...
![Image 14](https://tryhackme-images.s3.amazonaws.com/user-uploads/60c7fac321aca20049602d2b/room-content/a6e36c7601f7b4ec07ce2a102ffb33ab.png)
...
![Image 15](https://tryhackme-images.s3.amazonaws.com/user-uploads/60c7fac321aca20049602d2b/room-content/642cac93b8c5b7bf8c82d448cb48c1d1.png)
...
Answer the questions belowWhat browser uses the User-Agent string shown in the screenshot above?Correct AnswerHintHow many POST requests are in the screenshot from the pcap file?
...
![Image 16](https://tryhackme-images.s3.amazonaws.com/user-uploads/60c7fac321aca20049602d2b/room-content/20624b49722fd8d0ba062d6206c1d021.png)

**The execution of the suspicious binary:**

![Image 17](https://tryhackme-images.s3.amazonaws.com/user-uploads/60c7fac321aca20049602d2b/room-content/8638b80dc730bfc88e37633f648b15e2.png)
...
![Image 18](https://i.ibb.co/qnyYHtR/ssdeep.png)

Answer the questions belowProvide the method used to determine similarity between the files Correct AnswerProvide the alternative name for fuzzy hashes without the abbreviation
...
Answer the questions belowNavigate to ATT&CK Matrix webpage. How many techniques fall under the Exfiltration category?Correct AnswerChimera is a China-based hacking group that has been active since 2018. What is the name of the commercial, remote access tool they use for C2 beacons and data exfiltration?
...
View SiteDeploy the static site attached to this task and place the prompts into the correct tiers in the pyramid of pain!

Once you are sure, submit your answer on the static site to retrieve a flag!

Answer the questions belowComplete the static site. What is the flag?Correct Answer
...
Answer the questions belowRead the above.Complete
