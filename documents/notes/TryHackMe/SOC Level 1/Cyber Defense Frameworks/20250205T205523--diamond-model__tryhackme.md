...
tags:       ["tryhackme"]
identifier: "20250205T205523"
hubs: "TryHackMe/SOC Level 1/Cyber Defense Frameworks"
id: ba3772e4-f9b5-4ecd-b1f4-d0557d670c5a
---

### SOC Level 1 > Cyber Defence Frameworks > Diamond Model

### [TryHackMe | Diamond Model](https://tryhackme.com/r/room/diamondmodelrmuwwg42)
...
As an example, an adversary customer could control different operators simultaneously. Each operator might have its capabilities and infrastructure.Answer the questions belowWhat is the term for a person/group that has the intention to perform malicious actions against cyber resources?Correct AnswerWhat is the term of the person or a group that will receive the benefits from the cyberattacks?

Correct Answer

### **Answer the questions below**

**Question:** What is the term for a person/group that has the intention to perform malicious actions against cyber resources?

*Answer:* 

     Adversary Operator

**Question:** What is the term of the person or a group that will receive the benefits from the cyberattacks?
...
Answer the questions belowWhat is the term that applies to the Diamond Model for organizations or people that are being targeted?Correct Answer

### **Answer the questions below**

**Question:** What is the term that applies to the Diamond Model for organizations or people that are being targeted?
...
An adversary must have the required capabilities. The capabilities can be malware and phishing email development skills or, at least, access to capabilities, such as acquiring malware or ransomware as a service.Answer the questions belowProvide the term for the set of tools or capabilities that belong to an adversary.Correct Answer

### **Answer the questions below**

**Question:** Provide the term for the set of tools or capabilities that belong to an adversary.
...
**Service Providers** are organizations that provide services considered critical for the adversary availability of Type 1 and Type 2 Infrastructures, for example, Internet Service Providers, domain registrars, and webmail providers.Answer the questions belowTo which type of infrastructure do malicious domains and compromised email accounts belong?

Correct AnswerWhat type of infrastructure is most likely owned by an adversary?

Correct Answer

### **Answer the questions below**

**Question:** To which type of infrastructure do malicious domains and compromised email accounts belong?

*Answer:* 

     Type 2 Infrastructure

**Question:** What type of infrastructure is most likely owned by an adversary?
...
![Image 1](https://assets.tryhackme.com/additional/diamondmodel/Diamond%20Model%20-%20task%20image%20update.png)
...
Answer the questions belowWhat meta-feature does the axiom "Every malicious activity contains two or more phases which must be successfully executed in succession to achieve the desired result" belong to? Correct AnswerYou can label the event results as "success", "failure", and "unknown". What meta-feature is this related to? Correct AnswerTo what meta-feature is this phrase applicable "Every intrusion event requires one or more external resources to be satisfied prior to success"? Correct Answer

### **Answer the questions below**

**Question:** What meta-feature does the axiom "Every malicious activity contains two or more phases which must be successfully executed in succession to achieve the desired result" belong to?

*Answer:* 

     Phase

**Question:** You can label the event results as "success", "failure", and "unknown". What meta-feature is this related to?

*Answer:* 

     Result

**Question:** To what meta-feature is this phrase applicable "Every intrusion event requires one or more external resources to be satisfied prior to success"?
...
The scenario can be that the victim provides a “product”, for example, computing resources & bandwidth as a zombie in a botnet for crypto mining (producing new cryptocurrencies by solving cryptographic equations through the use of computers) purposes, while the adversary consumes their product or gets financial gain. Answer the questions belowRead the above.Correct Answer
...
**Question:** Ensure you have deployed the static site attached to this task. To complete the static site, you will need to click on each triangular section of the diamond until you have completed all eight areas of the diamondComplete all eight areas of the diamond. What is the flag that is displayed to you?
