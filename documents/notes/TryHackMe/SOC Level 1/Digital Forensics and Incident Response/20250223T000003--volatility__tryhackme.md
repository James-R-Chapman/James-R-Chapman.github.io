...
tags:       ["tryhackme"]
identifier: "20250223T000003"
Hubs: "TryHackMe/SOC Level 1/Digital Forensics and Incident Response"
urls: (https://tryhackme.com/room/volatility)
id: de02298c-ac94-402e-9041-282e142d69e5
---
...
**Question:** Read the above and move on to installing Volatility.
...
![Image 2](https://avatars.githubusercontent.com/u/6001145?s=280&v=4)
...
Start MachineSince Volatility is written purely in Python, it makes the installation steps and requirements very easy and universal for Windows, Linux, and Mac. If you already attempted to use Python on Windows and Mac, it is suggested to begin on Linux; however, all operating systems will work the same.

 If you're using TryHackMe's AttackBox, Volatility is already present on the box, and you can skip these steps and move on.

![Image 3](https://www.python.org/static/community_logos/python-logo-inkscape.svg)
...
**Question:** Read the above and install Volatility or start the AttackBox or boot the provided machine.
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/5e73cca6ec4fcf1309f2df86/room-content/17eb1ceec9932bc5e445613ff5f5aa88.png)
...
**Question:** Read the above and understand the various methods of memory extraction.
...
**Question:** Read the above and review the Volatility help menu.
...
**Question:** Read the above and move on to listing processes and connections.

*Answer:* 

     No answer needed

**Question:** To practice any commands in this room you can utilize either of the memory files present in the /Scenarios/Investigations/ directory or downloaded from Task 1.
...
**Question:** Read the above and practice dumping processes and connections on the provided memory file.
...
**Question:** Read the above and practice your hunting capabilities with Volatility.
...
**Question:** Read the above and practice looking through the SSDT and drivers.

*Answer:* 

     No answer needed

**Question:** Research the other plugins provided; some of them will be used within the practical investigations.
...
**Question:** What process can be considered suspicious in Case 001?Note: Certain special characters may not be visible on the provided VM. When doing a copy-and-paste, it will still copy all characters.
