...
tags:       ["tryhackme"]
identifier: "20250223T000002"
Hubs: "TryHackMe/SOC Level 1/Digital Forensics and Incident Response"
urls: (https://tryhackme.com/room/velociraptorhp)
id: ed247f4d-5929-4429-9873-4c0ba443b506
---
...
Per the official Velociraptor [documentation](https://docs.velociraptor.app/docs/overview/), "*Velociraptor is a unique, advanced open-source endpoint monitoring, digital forensic and cyber response platform.* *It was developed by Digital Forensic and Incident Response (DFIR) professionals who needed a powerful and efficient way to hunt for specific artifacts and monitor activities across fleets of endpoints. Velociraptor provides you with the ability to more effectively respond to a wide range of digital forensic and cyber incident response investigations and data breaches* ".
...
**Question:** Click me once you have read through the introductory task!
...
Start Machine**Deploying Velociraptor**
...
![Image 1](https://assets.tryhackme.com/additional/velociraptor/split-view-2.png)

For a better experience, expand the Split View to full-screen mode.

![Image 2](https://assets.tryhackme.com/additional/velociraptor/expand-split-view.png)
...
![Image 3](https://assets.tryhackme.com/additional/velociraptor/ubuntu-taskbar.png)
...
![Image 4](https://assets.tryhackme.com/additional/velociraptor/google-shortcut.png)
...
![Image 5](https://assets.tryhackme.com/additional/velociraptor/welcome-screen.png)
...
**Question:** Using the documentation, how would you launch an Instant Velociraptor on Windows?
...
![Image 6](https://assets.tryhackme.com/additional/velociraptor/dashboard-grayed-out-links.png)
...
![Image 7](https://assets.tryhackme.com/additional/velociraptor/search-clients.png)

The output will display a list of client machines running the Velociraptor agent in a table form.

![Image 8](https://assets.tryhackme.com/additional/velociraptor/client-list.png)

Below is a brief explanation of each column.

**Online State** A green dot indicates the endpoint is online and communicating with the Velociraptor server. A yellow dot means the server hasn't received any communication from the endpoint within a 24-hour time frame. A red dot means it's been more than 24 hours since the server last heard from the endpoint. **Client ID** This is a unique ID assigned to the client by the Velociraptor server, and the server will use this client ID to identify the endpoint. A client ID always starts with the letter **C** .**Hostname** This is the hostname the client identifies itself to the Velociraptor server. Remember that hostnames can change, hence why Velociraptor uses the Client ID instead of identifying a client machine. **Operating System Version** The Velociraptor client can run on Windows, Linux, or MacOS. The details regarding the client operating system are displayed in this column. **Labels** Client machines may have multiple labels attached to them. This is useful to identify multiple clients as a group.Click on the agent to bring you to a semi-detailed view. By default, the view shown is the **overview**  for the client.
...
![Image 9](https://assets.tryhackme.com/additional/velociraptor/powershell-whoami.png)
...
![Image 10](https://assets.tryhackme.com/additional/velociraptor/collected1.png)
...
![Image 11](https://assets.tryhackme.com/additional/velociraptor/collected2b.png)
...
**Question:** What is the hostname for the client?

*Answer:* 

     THM-VELOCIRAPTOR.eu-west-1.compute.internal

**Question:** What is listed as the agent version?

*Answer:* 

     2021-04-11T22:11:10Z

**Question:** In the Collected tab, what was the VQL command to query the client user accounts?

*Answer:* 

     LET Generic_Client_Info_Users_0_0=SELECT Name, Description, Mtime AS LastLogin FROM Artifact.Windows.Sys.Users()

**Question:** In the Collected tab, check the results for the PowerShell whoami command you executed previously. What is the column header that shows the output of the command?

*Answer:* 

     Stdout

**Question:** In the Shell, run the following PowerShell command Get-Date. What was the PowerShell command executed with VQL to retrieve the result?
...
![Image 12](https://assets.tryhackme.com/additional/velociraptor/new-collection.png)
...
![Image 13](https://assets.tryhackme.com/additional/velociraptor/select-artifacts2.png)

**Configure Parameters**

![Image 14](https://assets.tryhackme.com/additional/velociraptor/configure-parameters.png)

Scroll down and check **Ubuntu** .

![Image 15](https://assets.tryhackme.com/additional/velociraptor/check-ubuntu.png)
...
![Image 16](https://assets.tryhackme.com/additional/velociraptor/specify-resources.png)
...
![Image 17](https://assets.tryhackme.com/additional/velociraptor/review-request.png)
...
![Image 18](https://assets.tryhackme.com/additional/velociraptor/collection-running.png)

Once the artifacts have been gathered, the state will change from an hourglass to a checkmark like the others.

![Image 19](https://assets.tryhackme.com/additional/velociraptor/collection-done-2.png)
...
**Question:** Earlier you created a new artifact collection for Windows.KapeFiles.Targets. You configured the parameters to include Ubuntu artifacts. Review the parameter description for this setting. What is this parameter specifically looking for?
...
![Image 20](https://assets.tryhackme.com/additional/velociraptor/default-vfs.png)
...
![Image 21](https://assets.tryhackme.com/additional/velociraptor/vfs-buttons-2.png)
...
**Question:** Which accessor can access hidden NTFS files and Alternate Data Streams? (format: xyz accessor)

*Answer:* 

     ntfs accessor

**Question:** Which accessor provides file-like access to the registry? (format: xyz accessor)

*Answer:* 

     registry accessor

**Question:** What is the name of the file in $Recycle.Bin?

*Answer:* 

     desktop.ini

**Question:** There is hidden text in a file located in the Admin's Documents folder. What is the flag?
...
![Image 22](https://assets.tryhackme.com/additional/velociraptor/vql-example.png)
...
![Image 23](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/a107fe7d78711c90b9c31f5584e4c281.gif)
...
![Image 24](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/d2879fb5600bbe69f4b2d3e67e8de2ef.gif)
...
![Image 25](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/f01b684ac748c4484a4949adfae0ba89.png)

Let's save this notebook and run it against the agent as demonstrated below.

![Image 26](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/f12b007342f3041b129d70edd408c2bf.gif)
...
![Image 27](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de96d9ca744773ea7ef8c00/room-content/646326ad4c3925702619529657e3ee36.gif)
...
**Question:** What is followed after the SELECT keyword in a standard VQL query?

*Answer:* 

     Column Selectors

**Question:** What goes after the FROM  keyword?

*Answer:* 

     VQL Plugin

**Question:** What is followed by the WHERE keyword?

*Answer:* 

     Filter expression

**Question:** What can you type in the Notepad interface to view a list of possible completions for a keyword?
...
**Question:** What are the arguments for parse_mft()?

*Answer:* 

     parse_mft(filename="C:/$MFT", accessor="ntfs")

**Question:** What filter expression will ensure that no directories are returned in the results?
...
Start Machine**Hunt for a nightmare**

Terminate the previous virtual machine and spawn the virtual machine attached to this task.

![Image 28](https://assets.tryhackme.com/additional/velociraptor/split-view-2.png)
...
**Question:** What is the name in the Artifact Exchange to detect Printnightmare?

*Answer:* 

     Windows.Detection.PrintNightmare

**Question:** Per the above instructions, what is your Select clause? (no spaces after commas)

*Answer:* 

     SELECT "C:/" + FullPath AS Full_Path,FileName AS File_Name,parse_pe(file="C:/" + FullPath) AS PE

**Question:** What is the name of the DLL that was  placed by the attacker?

*Answer:* 

     nightmare.dll

**Question:** What is the PDB entry?
