...
tags:       ["tryhackme"]
identifier: "20250221T000001"
Hubs: "TryHackMe/SOC Level 1/Digital Forensics and Incident Response"
urls: (https://tryhackme.com/room/btredlinejoxr3d)
id: 471725c4-9a4a-475e-a7c6-cd2f4207ea9e
---
...
![Image 3](https://assets.tryhackme.com/additional/redline101/capture2.png)
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/021b2784b3b39c0e5817c79815885a15.png)
...
![Image 6](https://assets.tryhackme.com/additional/redline101/targetos.png)
...
![Image 7](https://assets.tryhackme.com/additional/redline101/memoryyy.png)
...
![Image 8](https://assets.tryhackme.com/additional/redline101/diskkk.png)
...
![Image 9](https://assets.tryhackme.com/additional/redline101/systemm.png)
...
![Image 10](https://assets.tryhackme.com/additional/redline101/networkkk.png)

Other:

![Image 11](https://assets.tryhackme.com/additional/redline101/other.png)
...
![Image 12](https://assets.tryhackme.com/additional/redline101/32.png)
...
![Image 13](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/f8ddaa960778e373c108ea2fa3ebe67f.png)
...
![Image 14](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/ef6666436c67665ba44f03f149a89320.png)
...
![Image 15](https://assets.tryhackme.com/additional/redline101/1213.png)
...
![Image 16](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/93f84b334ff930f8fdbb3bb316d010c3.png)
...
**Question:** What data collection method takes the least amount of time?

*Answer:* 

     Standard Collector

**Question:** You are reading a research paper on a new strain of ransomware. You want to run the data collection on your computer based on the patterns provided, such as domains, hashes, IP addresses, filenames, etc. What method would you choose to run a granular data collection against the known indicators?

*Answer:* 

     IOC Search Collector

**Question:** What script would you run to initiate the data collection process? Please include the file extension.

*Answer:* 

     RunRedlineAudit.bat

**Question:** If you want to collect the data on Disks and Volumes, under which option can you find it?

*Answer:* 

     Disk Enumeration

**Question:** What cache does Windows use to maintain a preference for recently executed code?
...
![Image 17](https://i.ibb.co/CH6zS38/red1.png)

When the data is imported, you will be presented with this view:

![Image 18](https://i.ibb.co/8YhfzHb/redlineee.png)
...
![Image 19](https://i.ibb.co/mN1GyRf/files.png)
...
![Image 20](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/0d3564554dec83b1e948cf2e78a41b26.png)

![Image 21](https://i.ibb.co/k4gB91m/wrinklee.png)
...
![Image 22](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/e38cdd16a6b56e484a6d9a4549c7348b.png)

![Image 23](https://i.ibb.co/RTc3t0z/timeline2.png)
...
**Question:** Where in the Redline UI can you view information about the Logged in User?
...
![Image 24](https://tryhackme-images.s3.amazonaws.com/user-uploads/5c549500924ec576f953d9fc/room-content/61070d399810d7dbde6a33ff091208a9.png)
...
**Question:** Provide the Operating System detected for the workstation.

*Answer:* 

     Windows Server 2019 Standard 17763

**Question:** Be sure to check the rest of the System Information section for other useful data.

*Answer:* 

     No answer needed

**Question:** What is the suspicious scheduled task that got created on the victim's computer?

*Answer:* 

     MSOfficeUpdateFa.ke

**Question:** Find the message that the intruder left for you in the task.

*Answer:* 

     THM-p3R5IStENCe-m3Chani$m

**Question:** There is a new System Event ID created by an intruder with the source name "THM-Redline-User" and the Type "ERROR". Find the Event ID #.

*Answer:* 

     546

**Question:** Provide the message for the Event ID.

*Answer:* 

     Someone cracked my password. Now I need to rename my puppy-++-

**Question:** It looks like the intruder downloaded a file containing the flag for Question 8. Provide the full URL of the website.

*Answer:* 

     https://wormhole.app/download-stream/gI9vQtChjyYAmZ8Ody0AuA

**Question:** Provide the full path to where the file was downloaded to including the filename.

*Answer:* 

     C:\Program Files (x86)\Windows Mail\SomeMailFolder\flag.txt

**Question:** Provide the message the intruder left for you in the file.
...
![Image 26](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/b26d9e80ac55821643531c3a0436f633.png)

**Keylogger indicators in IOC Editor** :

![Image 27](https://i.ibb.co/02VS0M6/keylogger2.png)
...
![Image 28](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/01db4361981d214c2692aa10d59961d1.gif)

Once you select an item you can enter the value for the item directly.

![Image 29](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/81e9ffdb97a2ce98e8b9cec57a2be261.png)
...
![Image 31](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/5a0e549950f7ca673699d51a2ff14bc9.png)

Once you enter the value click Save to save it.

![Image 32](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/9d95abf1f3d62f3fe7d2eb6352b86235.png)

**Note** : You can right-click on an item for additional options. See below.

![Image 33](https://tryhackme-images.s3.amazonaws.com/user-uploads/5de58e2bfac4a912bcc7a3e9/room-content/f5173beaf331e84b7672daf6be726092.png)
...
![Image 37](https://i.ibb.co/SwvyRyq/ioc.png)
...
![Image 38](https://i.ibb.co/2S2t1sB/keylogger.png)
...
![Image 39](https://i.ibb.co/g7JkhPr/keylogger3.png)
...
![Image 40](https://tryhackme-images.s3.amazonaws.com/user-uploads/5c549500924ec576f953d9fc/room-content/014d546f9f31bb0e7458c835ebf17386.png)
...
![Image 41](https://i.ibb.co/xhJwX1f/analysis.png)
...
![Image 43](https://i.ibb.co/bvVVdj5/keyllogger4.png)
...
![Image 44](https://i.ibb.co/d0RCvdH/hits2.png)
...
![Image 45](https://i.ibb.co/tzvyS6w/hits3.png)
...
**Question:** What is the actual filename of the Keylogger?

*Answer:* 

     psylog.exe

**Question:** What filename is the file masquerading as?

*Answer:* 

     THM1768.exe

**Question:** Who is the owner of the file?

*Answer:* 

     WIN-2DET5DP0NPT\charles

**Question:** What is the file size in bytes?

*Answer:* 

     35400

**Question:** Provide the full path of where the .ioc file was placed after the Redline analysis, include the .ioc filename as well
...
![Image 46](https://tryhackme-images.s3.amazonaws.com/user-uploads/5c549500924ec576f953d9fc/room-content/689730e28d84b02fda211340cef6f961.png)
...
**Question:** Provide the path of the file that matched all the artifacts along with the filename.

*Answer:* 

     C:\Users\Administrator\AppData\Local\Temp\8eJv8w2id6IqN85dfC.exe

**Question:** Provide the path where the file is located without including the filename.
...
**Question:** Provide the subsystem for the file.

*Answer:* 

     Windows_CUI

**Question:** Provide the Device Path where the file is located.

*Answer:* 

     \Device\HarddiskVolume2

**Question:** Provide the hash (SHA-256) for the file.

*Answer:* 

     57492d33b7c0755bb411b22d2dfdfdf088cbbfcd010e30dd8d425d5fe66adff4

**Question:** The attacker managed to masquerade the real filename. Can you find it having the hash in your arsenal?
...
![Image 47](https://tryhackme-images.s3.amazonaws.com/user-uploads/5c549500924ec576f953d9fc/room-content/ec5d02b76c3edd1a0cede932c1f56230.png)
...
**Question:** Can you identify the product name of the machine?

*Answer:* 

     Windows 7 Home Basic

**Question:** Can you find the name of the note left on the Desktop for the "Charles"?

*Answer:* 

     _R_E_A_D___T_H_I_S___AJYG1O_.txt

**Question:** Find the Windows Defender service; what is the name of its service DLL?

*Answer:* 

     MpSvc.dll

**Question:** The user manually downloaded a zip file from the web. Can you find the filename?

*Answer:* 

     eb5489216d4361f9e3650e6a6332f7ee21b0bc9f3f3a4018c69733949be1d481.zip

**Question:** Provide the filename of the malicious executable that got dropped on the user's Desktop.

*Answer:* 

     Endermanch@Cerber5.exe

**Question:** Provide the MD5 hash for the dropped malicious executable.

*Answer:* 

     fe1bc60a95b2c2d77cd5d232296a7fa4

**Question:** What is the name of the ransomware?
...
![Image 48](https://tryhackme-images.s3.amazonaws.com/user-uploads/5c549500924ec576f953d9fc/room-content/32ff39b2850d42ca81344fa6191c5c2b.png)
