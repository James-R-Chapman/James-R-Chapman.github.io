...
tags:       ["tryhackme"]
identifier: "20250219T000000"
Hubs: "TryHackMe/SOC Level 1/Digital Forensics and Incident Response"
urls: (https://tryhackme.com/room/btautopsye0)
id: ccbbde02-4234-4eeb-bc48-8aa7cef1c822
---
...
This room's objective is to provide an overview of using the Autopsy tool to analyse disk images. The assumption is that you are familiar with the Windows operating system and Windows artefacts in relation to forensics. Before proceeding, start the attached virtual machine. The VM is ready to use with the **"Split View"**  feature. If you wish to use **RDP** , the credentials are below.

   

![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/94fe3c0f556877a2721ca9e0744ad026.png)

     **Username**  administrator   **Password**  letmein123!   **Machine IP**  `10.10.64.50`

### **Answer the questions below**

**Question:** Start the virtual machine.
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/e488c3548327c1bd78aff63060e2d2a9.png)
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/e54b49da6843e66582b797a8a3553723.png)

![Image 4](https://assets.tryhackme.com/additional/autopsy/autopsy-casename2.png)
...
![Image 5](https://assets.tryhackme.com/additional/autopsy/autopsy-missing-image3.png)

Once the case you wish to analyse is open, you are ready to start exploring the data.

### **Answer the questions below**

**Question:** What is the file extension of the Autopsy files?

*Answer:* 

     .aut

**Question:** Import the "Sample Case.aut" file (located on the Desktop) as shown in the task and continue to the next task.
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/c75224413dfb9884adbdc8c5a778383d.png)
...
**Question:** What is the disk image name of the "e01" format?
...
![Image 7](https://assets.tryhackme.com/additional/autopsy/autopsy-configure-modules.png)
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/04138be7675286ea5f9066a893c0b199.png)
...
![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/9ee9f606ea3444fd04c45b15c2c7f819.png)
...
![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/212c83e75693ce2d8f485633a11dd697.png)
...
![Image 11](https://assets.tryhackme.com/additional/autopsy/autopsy-tree-view.png)
...
![Image 12](https://assets.tryhackme.com/additional/autopsy/autopsy-table-view.png)
...
![Image 13](https://assets.tryhackme.com/additional/autopsy/autopsy-table-view2.png)
...
![Image 14](https://assets.tryhackme.com/additional/autopsy/autopsy-thumbnail-view.png)

Volume nodes can be expanded, and an analyst can navigate the volume's contents like a typical Windows system.

![Image 15](https://assets.tryhackme.com/additional/autopsy/autopsy-volume.png)

In the **Views**  tree node, files are categorised by File Types - **By Extension, By**  **MIME Type** , **Deleted Files** , and **By**  **File Size** .

![Image 16](https://assets.tryhackme.com/additional/autopsy/autopsy-views.png)
...
![Image 17](https://assets.tryhackme.com/additional/autopsy/autopsy-byextension.png)
...
![Image 18](https://assets.tryhackme.com/additional/autopsy/autopsy-contents-view.png)
...
![Image 19](https://assets.tryhackme.com/additional/autopsy/autopsy-keyword-search.png)

In the image above, the analyst searches for the word 'secret.' Below are the search results.

![Image 20](https://assets.tryhackme.com/additional/autopsy/autopsy-keyword-search2.png)
...
![Image 21](https://assets.tryhackme.com/additional/autopsy/autopsy-statusbar2.png)
...
**Question:** Expand the "Data Sources" option; what is the number of available sources?

*Answer:* 

     4

**Question:** What is the number of the detected "Removed" files?

*Answer:* 

     10

**Question:** What is the filename found under the "Interesting Files" section?
...
![Image 22](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/a8ab6999fabaf538c2e9eb3742b0ff29.png)
...
![Image 23](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/581fe3b1caa19ed94ad2564e3ecd8003.png)
...
![Image 24](https://tryhackme-images.s3.amazonaws.com/user-uploads/6131132af49360005df01ae3/room-content/68fc3dcf815f47183dd62c35438dc98c.png)

### **Answer the questions below**

**Question:** What is the full name of the operating system version?

*Answer:* 

     Windows 7 Ultimate Service Pack 1

**Question:** What percentage of the drive are documents? Include the % in your answer.

*Answer:* 

     40.8%

**Question:** Generate an HTML report as shown in the task and view the "Case Summary" section.What is the job number of the "Interesting Files Identifier" module?
...
![Image 25](https://assets.tryhackme.com/additional/autopsy/autopsy-missing-image2.png)
...
![Image 26](https://assets.tryhackme.com/additional/autopsy/autopsy-top-bar.png)
...
![Image 27](https://assets.tryhackme.com/additional/autopsy/autopsy-timeline.png)
...
![Image 28](https://assets.tryhackme.com/additional/autopsy/autopsy-timeline-details.png)
...
![Image 29](https://assets.tryhackme.com/additional/autopsy/autopsy-timeline-clustered.png)

To expand a cluster, click on the `green icon with the plus sign`**** . See the below example.

![Image 30](https://assets.tryhackme.com/additional/autopsy/autopsy-cluster-expand.png)
...
![Image 31](https://assets.tryhackme.com/additional/autopsy/autopsy-timeline-clustered2.png)
...
![Image 32](https://assets.tryhackme.com/additional/autopsy/autopsy-timeline-hidden.png)
...
![Image 33](https://assets.tryhackme.com/additional/autopsy/autopsy-timeline-unhide.png)

Last but not least, a screenshot of the **List**  View Mode is below.

![Image 34](https://assets.tryhackme.com/additional/autopsy/autopsy-timeline-list.png)

This should be enough information to get you started interacting with the Timeline with some level of confidence.

### **Answer the questions below**

**Question:** Using the Timeline, how many results were there on 2015-01-12?

*Answer:* 

     46

**Question:** The majority of file events occurred on what date? (MONTH DD, YYYY)
...
**Question:** Proceed to the given challenge room.Disk Analysis & Autopsy
