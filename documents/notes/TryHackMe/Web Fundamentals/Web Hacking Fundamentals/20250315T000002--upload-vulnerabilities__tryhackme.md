...
Start Machine**Please read and follow the instructions in this task carefully. If you skip over this task and encounter connectivity errors as a result, the Discord volunteers reserve the right to ignore you** .
...
`MACHINE_IP    overwrite.uploadvulns.thm shell.uploadvulns.thm 
...
`10.10.10.10    overwrite.uploadvulns.thm shell.uploadvulns.thm 
java.uploadvulns.thm annex.uploadvulns.thm magic.uploadvulns.thm 
jewel.uploadvulns.thm demo.uploadvulns.thmMACHINE_IP    overwrite.uploadvulns.thm shell.uploadvulns.thm java.uploadvulns.thm annex.uploadvulns.thm magic.uploadvulns.thm jewel.uploadvulns.thm demo.uploadvulns.thm`
...
**Question:** I solemly swear that I have read (and fully understood) the above information.I have configured my machine as instructed.
...
**Question:** Read and understand the above information.
...
**Question:** Read the General Methodology
...
![Image 1](https://i.imgur.com/7KmsrTW.png)
...
![Image 2](https://i.imgur.com/BeqAZ3s.png)
...
![Image 3](https://i.imgur.com/8PiIuiu.png)

![Image 4](https://i.imgur.com/TIoA2DR.png)
...
**Question:** What is the name of the image file which can be overwritten?

*Answer:* 

     mountains.jpg

**Question:** Overwrite the image. What is the flag you receive?
...
![Image 5](https://i.imgur.com/GxMJAKH.png)

**

Where do we go from here? Well, let's start with a gobuster scan:

![Image 6](https://i.imgur.com/OftwAIE.png)
...
![Image 7](https://i.imgur.com/aAyIrod.png)

![Image 8](https://i.imgur.com/mIbGRIk.png)

Now, if we go to `http://demo.uploadvulns.thm/uploads` we should see that the spaniel picture has been uploaded!

![Image 9](https://i.imgur.com/lVe2tjL.png)

![Image 10](https://i.imgur.com/N8vWlVO.png)
...
![Image 11](https://i.imgur.com/CU0Uyx5.png)
...
![Image 12](https://i.imgur.com/ysY306E.png)
...
![Image 13](https://i.imgur.com/he0hbiR.png)
...
**Question:** Run a Gobuster scan on the website using the syntax from the screenshot above. What directory looks like it might be used for uploads?(N.B. This is a good habit to get into, and will serve you well in the upcoming tasks...)

*Answer:* 

     /resources

**Question:** Get either a web shell or a reverse shell on the machine.What's the flag in the /var/www/ directory of the server?
...
![Image 14](https://i.imgur.com/uptWRKW.png)
...
![Image 15](https://i.imgur.com/vHQWOgi.png)
...
**Question:** What is the traditionally predominant server-side scripting language?

*Answer:* 

     PHP

**Question:** When validating by file extension, what would you call a list of accepted extensions (whereby the server rejects any extension not in the list)?

*Answer:* 

     Whitelist

**Question:** [Research] What MIME type would you expect to see when uploading a CSV file?
...
![Image 16](https://i.imgur.com/fI67jX0.png)
...
![Image 17](https://i.imgur.com/TrI5jQD.png)
...
![Image 18](https://i.imgur.com/T0RjAry.png)
...
![Image 19](https://i.imgur.com/ACgWLpH.png)
...
![Image 20](https://i.imgur.com/5cyqjqa.png)
...
![Image 21](https://i.imgur.com/95hi6pX.png)
...
![Image 24](https://i.imgur.com/sqmwssT.png)
...
![Image 25](https://i.imgur.com/cUqNO2L.png)
...
![Image 26](https://i.imgur.com/yzOGVob.png)
...
![Image 27](https://i.imgur.com/Aigaz4R.png)
...
![Image 28](https://i.imgur.com/STsI51E.png)
...
![Image 29](https://i.imgur.com/tp6T2WH.png)
...
![Image 30](https://i.imgur.com/hk4inJ2.png)
...
`ACCEPT FILE FROM THE USER -- SAVE FILENAME IN VARIABLE userInputIF STRING ".jpg" IS IN VARIABLE userInput:    SAVE THE FILEELSE:    RETURN ERROR MESSAGE`
...
![Image 33](https://i.imgur.com/yQnQGsn.png)
...
![Image 34](https://i.imgur.com/2126EHS.png)
...
![Image 35](https://i.imgur.com/oe434wu.png)
...
![Image 36](https://i.imgur.com/otIyN96.png)
...
![Image 37](https://i.imgur.com/2OlGKdQ.png)
...
**Question:** Read the example methodology
...
Download Task FilesIt's challenge time!
...
**Question:** Hack the machine and grab the flag from /var/www/
...
**Question:** Room completed, and hosts file reverted!
