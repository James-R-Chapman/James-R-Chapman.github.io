...
tags:       ["tryhackme"]
identifier: "20250309T000003"
Hubs: "TryHackMe/Web Fundamentals/Introduction to Web Hacking"
urls: (https://tryhackme.com/room/sqlinjectionlm)
id: 197098e2-7423-4c84-a999-8a8eb74fc7ae
---
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5efe36fb68daf465530ca761/room-content/f31d5855476c01e8359df000da4ac79d.png)
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5efe36fb68daf465530ca761/room-content/cee2844345f5ab5bc704b163797b3604.png)
...
**Question:** What is the acronym for the software that controls a database?

*Answer:* 

     DBMS

**Question:** What is the name of the grid-like structure which holds the data?
...
London
NW12 3GH
Widgets LtdUnit 1a, Newby EstateBristolBS19 4RTThe Tool Company75 Industrial RoadNorwichN22 3DRAxe Makers Ltd2b Makers Unit, Market Road LondonSE9 1KKINSERT
...
bob
password123
UPDATEThe **UPDATE**  statement tells the database we wish to update one or more rows of data within a table. You specify the table you wish to update using "**update %tablename% SET** " and then select the field or fields you wish to update as a comma-separated list such as "**username='root',password='pass123'** " then finally, similar to the SELECT statement, you can specify exactly which rows to update using the where clause such as "**where username='admin;** ".
...
bob
password123
DELETEThe **DELETE**  statement tells the database we wish to delete one or more rows of data. Apart from missing the columns you wish to return, the format of this query is very similar to the SELECT. You can specify precisely which data to delete using the **where**  clause and the number of rows to be deleted using the **LIMIT**  clause.
...
**Question:** What SQL statement is used to retrieve data?

*Answer:* 

     SELECT

**Question:** What SQL clause can be used to retrieve data from multiple tables?

*Answer:* 

     UNION

**Question:** What SQL statement is used to add data?
...
**Question:** What character signifies the end of an SQL query?
...
**Practical:** **Click the green "Start Machine" button to use the SQL Injection Example practice lab. Each level contains a mock browser and also SQL Query and Error boxes to assist in getting your queries/payload correct.** Level one of the practice lab contains a mock browser and website featuring a blog with different articles, which can be accessed by changing the id number in the query string.
...
**Question:** What is the flag after completing level 1?
...
**Question:** What is the flag after completing level two? (and moving to level 3)
...
`admin123'
 UNION SELECT 1,2,3 FROM information_schema.COLUMNS WHERE 
TABLE_SCHEMA='sqli_three' and TABLE_NAME='users' and COLUMN_NAME like 
'a%';`****
...
**Question:** What is the flag after completing level three?
...
**Question:** What is the final flag after completing level four?
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/5efe36fb68daf465530ca761/room-content/75103b88e95d4eda2244dbb360cba4ff.png)

![Image 4]()

### **Answer the questions below**

**Question:** Name a protocol beginning with D that can be used to exfiltrate data from a database.
...
**Question:** Name a method of protecting yourself from an SQL Injection exploit.
