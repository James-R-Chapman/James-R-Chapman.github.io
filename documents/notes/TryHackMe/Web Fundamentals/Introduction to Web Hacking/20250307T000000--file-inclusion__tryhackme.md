...
tags:       ["tryhackme"]
identifier: "20250307T000000"
Hubs: "TryHackMe/Web Fundamentals/Introduction to Web Hacking"
urls: (https://tryhackme.com/room/fileinc)
id: a9960069-7b8b-428e-8748-2cd7105e1853
---
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/dbf35cc4f35fde7a4327ad8b5a2ae2ec.png)
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/dc22709e572d5de31ed4effb2ebc161f.png)

Why do File inclusion vulnerabilities happen? File inclusion vulnerabilities are commonly found and exploited in various programming languages for web applications, such as PHP that are poorly written and implemented. The main issue of these vulnerabilities is the input validation, in which the user inputs are not sanitized or validated, and the user controls them. When the input is not validated, the user can pass any input to the function, causing the vulnerability.
What is the risk of File inclusion?By default, an attacker can leverage file inclusion vulnerabilities to leak data, such as code, credentials or other important files related to the web application or operating system. Moreover, if the attacker can write files to the server by any other means, file inclusion might be used in tandem to gain remote command execution (RCE).

### **Answer the questions below**

**Question:** Let's continue to the next section to deploy the attached VM.
...
Start MachineDeploy the attached VM to follow and apply the technique as well as do the challenges. In order to access this VM, please make sure to connect to the [TryHackMe network](https://tryhackme.com/access) via OpenVPN or access it directly from the AttackBox, which can be launched by clicking the blue button on the top-right.

Please visit the link http://10.10.75.120/, which will show you the following page:

![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/42921fa9ea04452912025351a430679d.png)

### **Answer the questions below**

**Question:** Once you've deployed the VM, please wait a few minutes for the webserver to start, then progress to the next section!
...
Path Traversal
 ...
 ![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/45d9c1baacda290c1f95858e27f740c9.png)
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/3037513935e3242f74bd0fe97833b5ac.png)
...
![Image 6]()
 ...
 ![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/c12d34456ebe25bafffeb829c58f98c0.png)
 ...
 Sometimes, developers will add filters to limit access to only certain files or directories. Below are some common OS files you could use when testing.
    ...
    **Location**  **Description**     `/etc/issue`
  ...
  contains information about the system's users' passwords
   ...
   contains the history commands for `root
                    `user
...
**Question:** What function causes path traversal vulnerabilities in PHP?
...
**Question:** In Lab #2, what is the directory specified in the include function?
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/30d3bf0341ba99485c5f683a416a056d.png)
...
**Question:** Give Lab #3 a try to read /etc/passwd. What is the request look like?

*Answer:* 

     /lab3.php?file=../../../../etc/passwd 

**Question:** Which function is causing the directory traversal in Lab #4?

*Answer:* 

     file_get_contents

**Question:** Try out Lab #6 and check what is the directory that has to be in the input field?

*Answer:* 

     THM-profile

**Question:** Try out Lab #6 and read /etc/os-release. What is the VERSION_ID value?
...
![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/b0c2659127d95a0b633e94bd00ed10e0.png)
...
Visit the following lab URL: http://10.10.75.120/playground.php[](http://10.10.75.120//playground.php) to try out an RFI attack.

### **Answer the questions below**

**Question:** We showed how to include PHP pages via RFI. Do research on how to get remote command execution (RCE), and answer the question in the challenge section.
...
**Question:** Ready for the challenges?
...
Make sure the attached VM is up and running then visit: http://10.10.75.120/challenges/index.php
...
**Question:** Capture Flag1 at /etc/flag1

*Answer:* 

     F1x3d-iNpu7-f0rrn

**Question:** Capture Flag2 at /etc/flag2
...
**Question:** Gain RCE in Lab #Playground /playground.php with RFI to execute the hostname command. What is the output?
