...
urls: (https://tryhackme.com/room/walkinganapplication)
id: c448ff79-7fa4-4239-8945-d6db999de7b5
---
...
Press the "Start Machine" button to start the virtual machine on this task, then **wait 2 minutes** , and visit the following URL: [https://10-10-187-202.p.thmlabs.com](https://10-10-187-202.p.thmlabs.com/)[](https://10-10-187-202.p.thmlabs.com/) *(this URL will update 2 minutes from when you start the machine)*

Start Machine

### **Answer the questions below**

**Question:** I confirm that I have deployed the virtual machine and opened the website.
...
Home Page
/
This page contains a summary of what Acme IT Support does with a company photo of their staff.Latest News
/news
...
/customers/reset
Password reset form with an email address input field.Customer Dashboard
/customers
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/5efe36fb68daf465530ca761/room-content/ccc306acf34d0c83ffd18f33da1a5994.png)
...
**Question:** What is the flag from the HTML comment?

*Answer:* 

     THM{HTML_COMMENTS_ARE_DANGEROUS}

**Question:** What is the flag from the secret link?

*Answer:* 

     THM{NOT_A_SECRET_ANYMORE}

**Question:** What is the directory listing flag?

*Answer:* 

     THM{INVALID_DIRECTORY_PERMISSIONS}

**Question:** What is the framework flag?
...
**Opening Developer Tools** The way to access developer tools is different for every browser. If you're not sure how to access it, click the "View Site" button on the top right of this task to get instructions to how to access the tools for your browser.

**Inspecto** **r** The page source doesn't always represent what's shown on a webpage; this is because CSS, JavaScript and user interaction can change the content and style of the page, which means we need a way to view what's been displayed in the browser window at this exact time. Element inspector assists us with this by providing us with a live representation of what is currently on the website.
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/5efe36fb68daf465530ca761/room-content/96b49cec6712a47c4ea986d26c6b7451.png)
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/5efe36fb68daf465530ca761/room-content/0e3f5c5c8dd02916d6fc2637461293a9.png)
...
**Question:** What is the flag behind the paywall?
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/5efe36fb68daf465530ca761/room-content/d76d0b263799865be55d6725cbeaf21b.png)
...
**Question:** What is the flag in the red box?
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/5efe36fb68daf465530ca761/room-content/9ec0890f159397547950ea1822994443.png)
...
**Question:** What is the flag shown on the contact-msg network request?
