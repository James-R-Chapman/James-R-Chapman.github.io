...
id: 8ca059af-f763-4954-bc4e-c16095f32e17
---

### Cyber Security 101 > Offensive Security Tooling > SQLMap: The Basics
...
- Hunting SQL injection through the SQLMap tool
 ...
 Room Prerequisites While having a solid [SQL Fundamentals](https://tryhackme.com/r/room/sqlfundamentals) knowledge is helpful, it is not required to complete this room.

Answer the questions belowWhich language builds the interaction between a website and its database?
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/6645aa8c024f7893371eb7ac/room-content/6645aa8c024f7893371eb7ac-1727955724338.png)
...
Answer the questions belowWhich boolean operator checks if at least one side of the operator is true for the condition to be true?

Correct AnswerIs 1=1 in an SQL query always true? (YEA/NAY)
...
Answer the questions belowWhich flag in the SQLMap tool is used to extract all the databases available?

Correct AnswerWhat would be the full command of SQLMap for extracting all tables from the "members" database? (Vulnerable URL: http://sqlmaptesting.thm/search/cat=1)
...
**Question:** What would be the full command of SQLMap for extracting all tables from the "members" database? (Vulnerable URL: http://sqlmaptesting.thm/search/cat=1)
...
In this task, we've attached a vulnerable web application for you to test SQL injection vulnerabilities. Let's start the **Virtual Machine**  by pressing the **Start Machine**  button given below. The machine will start, and an IP address will be displayed to you. You can now open the attack box by clicking the **Start AttackBox**  button at the top. The AttackBox will open for you in the split view. You will use this machine to carry out SQL injection through the SQLMap tool.
 ...
 Start Machine **Note:** It is highly recommended to use the AttackBox for this task.
 ...
 ![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/6645aa8c024f7893371eb7ac/room-content/6645aa8c024f7893371eb7ac-1728644371711.png)
 ...
 ![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/6645aa8c024f7893371eb7ac/room-content/6645aa8c024f7893371eb7ac-1728644607260.png)
...
Answer the questions belowHow many databases are available in this web application?

Correct AnswerHintWhat is the name of the table available in the "ai" database?

Correct AnswerHintWhat is the password of the email test@chatai.com?

Correct AnswerHint

### **Answer the questions below**

**Question:** How many databases are available in this web application?

*Answer:* 

     6

**Question:** What is the name of the table available in the "ai" database?

*Answer:* 

     user

**Question:** What is the password of the email test@chatai.com?
