...
tags:       ["tryhackme"]
identifier: "20250205T205540"
hubs: "TryHackMe/Cyber Security 101/Offensive Security Tooling"
id: 867e1f5c-5791-497c-b216-9b5eb90d64a7
---

### Cyber Security 101 > Offensive Security Tooling > Shells Overview

### [TryHackMe | Shells Overview](https://tryhackme.com/r/room/shellsoverview)

# Task 1 | Room Introduction

Introduction Shells in cyber security are widely used by attackers to remotely control systems, making them an important part of the attack chain. In this room, we'll explore different shells used in offensive security, the differences between them, and their use cases. This knowledge can help enhance penetration testing and exploitation skills and also help us understand how to detect when a remote shell is being used by an attacker within an organization.
...
CaveatsThe use of Metasploit or other Frameworks that generate or interact with shells has been intentionally left behind from this room. This is to focus on understanding how shells work without the use or assistance of a tool to either set up or generate a shell. Also, for this room, we'll use Linux OS for all the examples.

Starting the Machine Start Machine Start the lab by clicking the `Start Machine` button. It will take around 2 minutes to load properly. The VM will be accessible on the right side of the split screen. In case the VM is not visible, use the blue Show Split View button at the top of the page.
...
Answer the questions belowClick to complete the task.
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/66c513e4445cb5649e636a36/room-content/66c513e4445cb5649e636a36-1727023855306.png)

 What is a Shell? A shell is software that allows a user to interact with an OS. It can be a graphical interface, but it is usually a command-line interface, and this will depend on the operating system running on the target system.
...
Answer the questions belowWhat is the command-line interface that allows users to interact with an operating system?

Correct AnswerWhat process involves using a compromised system as a launching pad to attack other machines in the network?

Correct AnswerWhat is a common activity attackers perform after obtaining shell access to escalate their privileges?

Correct Answer

### **Answer the questions below**

**Question:** What is the command-line interface that allows users to interact with an operating system?

*Answer:* 

     Shell

**Question:** What process involves using a compromised system as a launching pad to attack other machines in the network?

*Answer:* 

     Pivoting

**Question:** What is a common activity attackers perform after obtaining shell access to escalate their privileges?
...
Reverse Shell
 ...
 How Reverse Shells Work**Set up a Netcat (nc) Listener**  Let's now understand how a reverse shell works in a practical scenario using the tool Netcat. This utility supports multiple OSs and allows reading and writing through a network.
 ...
 **Attacker Receives the Shell**  Once the above payload is executed, the attacker will receive a **reverse shell** , as shown below, allowing them to execute commands as if they were logging into a regular terminal in the OS.
...
Answer the questions belowWhat type of shell allows an attacker to execute commands remotely after the target connects back?

Correct AnswerWhat tool is commonly used to set up a listener for a reverse shell?

Correct Answer

### **Answer the questions below**

**Question:** What type of shell allows an attacker to execute commands remotely after the target connects back?

*Answer:* 

     Reverse Shell

**Question:** What tool is commonly used to set up a listener for a reverse shell?
...
This method can be used when the compromised target does not allow outgoing connections, but it tends to be less popular since it needs to remain active and listen for connections, which can lead to detection.
 ...
 How bind shells work **Setting Up the Bind Shell on the Target**
...
Answer the questions belowWhat type of shell opens a specific port on the target for incoming connections from the attacker?

Correct AnswerListening below which port number requires root access or privileged permissions?

Correct Answer

### **Answer the questions below**

**Question:** What type of shell opens a specific port on the target for incoming connections from the attacker?

*Answer:* 

     Bind Shell

**Question:** Listening below which port number requires root access or privileged permissions?
...
Answer the questions belowWhich flexible networking tool allows you to create a socket connection between two data sources?

Correct AnswerWhich command-line utility provides readline-style editing and command history for programs that lack it, enhancing the interaction with a shell listener?

Correct AnswerWhat is the improved version of Netcat distributed with the Nmap project that offers additional features like SSL support for listening to encrypted shells?

Correct Answer

### **Answer the questions below**

**Question:** Which flexible networking tool allows you to create a socket connection between two data sources?

*Answer:* 

     socat

**Question:** Which command-line utility provides readline-style editing and command history for programs that lack it, enhancing the interaction with a shell listener?

*Answer:* 

     rlwrap

**Question:** What is the improved version of Netcat distributed with the Nmap project that offers additional features like SSL support for listening to encrypted shells?
...
Let's explore some of these payloads that can be used in the Linux OS to expose the shell through the most popular **reverse shell** .
 ...
 Bash **Normal Bash Reverse Shell**
...
```
 ...
 PHP **PHP Reverse Shell Using the exec Function**
...
Answer the questions belowWhich Python module is commonly used for managing shell commands and establishing reverse shell connections in security assessments?

Correct AnswerWhat shell payload method in a common scripting language uses the `exec`, `shell_exec`, `system`, `passthru`, and `popen` functions to execute commands remotely through a TCP connection?

Correct AnswerWhich scripting language can use a reverse shell by exporting environment variables and creating a socket connection?

Correct Answer

### **Answer the questions below**

**Question:** Which Python module is commonly used for managing shell commands and establishing reverse shell connections in security assessments?

*Answer:* 

     subprocess

**Question:** What shell payload method in a common scripting language uses the exec, shell_exec, system, passthru, and popen functions to execute commands remotely through a TCP connection?

*Answer:* 

     PHP

**Question:** Which scripting language can use a reverse shell by exporting environment variables and creating a socket connection?
...
```
    ...
    The above shell can be saved into a file with the PHP extension, like   `
    shell.php`, and then uploaded into the web server by the attacker by exploiting vulnerabilities such as [Unrestricted File Upload](https://tryhackme.com/r/room/uploadvulns), [File Inclusion](https://tryhackme.com/r/room/fileinc), [Command Injection](https://tryhackme.com/r/room/oscommandinjection), among others, or by gaining unauthorized access to it.      After the web shell is deployed in the server, it can be accessed through the URL where the web shell is hosted, in this example http://victim.com/uploads/shell.php. As we observed from the code in  `shell.php`, we need to provide a GET method and the value of the variable  `cmd`, which should contain the command the attacker wants to execute. For example, if we want to execute the command **whoami**  the request to the URL should be:    http://victim.com/uploads/shell.php?cmd=whoami  The above will execute the command **whoami**  and display the result in the web browser.   
...
- [p0wny-shell](https://github.com/flozz/p0wny-shell) - A minimalistic single-file PHP web shell that allows remote command execution. ![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/66c513e4445cb5649e636a36/room-content/66c513e4445cb5649e636a36-1727563529557.png)
- [b374k shell](https://github.com/b374k/b374k) - A more feature-rich PHP web shell with file management and command execution, among other functionalities.
 ![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/66c513e4445cb5649e636a36/room-content/66c513e4445cb5649e636a36-1727563529904.png)
- [c99 shell](https://www.r57shell.net/single.php?id=13) - A well-known and robust PHP web shell with extensive functionality. 
 ![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/66c513e4445cb5649e636a36/room-content/66c513e4445cb5649e636a36-1727563530257.png)

 You can find more web shells at: [https://www.r57shell.net/index.php](https://www.r57shell.net/index.php).

Answer the questions belowWhat vulnerability type allows attackers to upload a malicious script by failing to restrict file types?

Correct AnswerHintWhat is a malicious script uploaded to a vulnerable web application to gain unauthorized access?

Correct Answer

### **Answer the questions below**

**Question:** What vulnerability type allows attackers to upload a malicious script by failing to restrict file types?

*Answer:* 

     Unrestricted File Upload

**Question:** What is a malicious script uploaded to a vulnerable web application to gain unauthorized access?
...
Answer the questions belowUsing a reverse or bind shell, exploit the command injection vulnerability to get a shell. What is the content of the flag saved in the / directory?

Correct AnswerHintUsing a web shell, exploit the unrestricted file upload vulnerability and get a shell. What is the content of the flag saved in the / directory?

Correct AnswerHint

### **Answer the questions below**

**Question:** Using a reverse or bind shell, exploit the command injection vulnerability to get a shell. What is the content of the flag saved in the / directory?

*Answer:* 

     THM{0f28b3e1b00becf15d01a1151baf10fd713bc625}

**Question:** Using a web shell, exploit the unrestricted file upload vulnerability and get a shell. What is the content of the flag saved in the / directory?
...
Answer the questions belowI have successfully completed the room, and I now understand how Reverse Shells, Bind Shells, and Web Shells work!

Correct Answer

### **Answer the questions below**

**Question:** I have successfully completed the room, and I now understand how Reverse Shells, Bind Shells, and Web Shells work!
