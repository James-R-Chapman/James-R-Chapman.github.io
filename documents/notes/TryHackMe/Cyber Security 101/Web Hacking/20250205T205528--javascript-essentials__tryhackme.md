...
id: 46cd879d-4009-409d-b570-737e3a0bac15
---

### Cyber Security 101 > Web Hacking > JavaScript Essentials

### [TryHackMe | JavaScript Essentials](https://tryhackme.com/r/room/javascriptessentials)
...
- Exploring Minified Files
 ...
 Start Machine You can start the virtual machine by clicking `Start Machine`. The machine will start in a split-screen view. If the VM is not visible, use the blue `Show Split View` button at the top-left of the page. Please wait 1-2 minutes after the system boots completely to let the auto scripts run successfully.
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728824149791.png)
...
```
   ...
   Answer the questions belowI have successfully started the attached VM.
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728814492671.png)
...
Answer the questions belowWhat term allows you to run a code block multiple times as long as it is a condition?
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728734283854.png)

- Once Chrome is open, press `Ctrl + Shift + I` to open the `Console` or right-click anywhere on the page and select `Inspect`.

![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728734648811.png)
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728735227240.png)
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728735438271.png)
...
Answer the questions belowWhat is the code output if the value of x is changed to 10?

Correct AnswerIs JavaScript a compiled or interpreted language?
...
![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728843227930.png)
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728752465953.png)

In this HTML document, we are using internal JS, meaning the code is placed directly inside the HTML file within the **<script/>** tag. The script performs a simple task: it adds two numbers (x and y) and then displays the result on the web page. The JS interacts with the HTML by selecting an element (**<p/> with id="result"**) and updating its content using ``
``document.getElementById("result").innerHTML``. This internal JS is executed when the browser loads the HTML file.
...
![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728752440603.png)
...
![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728753467886.png)
...
![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728753567924.png)
...
![Image 12](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728753724407.png)

Answer the questions belowWhich type of JavaScript integration places the code directly within the HTML document?

Correct AnswerWhich method is better for reusing JS across multiple web pages?

Correct AnswerWhat is the name of the external JS file that is being called by **external_test.html** ?Correct AnswerWhat attribute links an external JS file in the <script/> tag?
...
![Image 13](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728802103400.png)
...
Once you paste the code and hit Enter, a dialogue box will appear, and the value entered by the user will be returned to the console.
 ...
 ![Image 14](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728801812878.png)
...
![Image 15](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728802070358.png)
...
![Image 16](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728802312967.png)
...
Answer the questions belowIn the file **invoice.html** , how many times does the code show the alert Hacked?

Correct AnswerWhich of the JS interactive elements should be used to display a dialogue box that asks the user for input?

Correct AnswerIf the user enters Tesla, what value is stored in the carName= prompt("What is your car name?")? in the carName variable?
...
**Question:** If the user enters Tesla, what value is stored in the carName= prompt("What is your car name?")? in the carName variable?
...
Double-click the file to open it in Google Chrome. You will see the following image:
 ...
 ![Image 17](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728803417509.png)
...
![Image 18](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728804039133.png)
...
![Image 19](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728803945443.png)

Answer the questions belowWhat is the message displayed if you enter the age less than 18?

Correct AnswerWhat is the password for the user admin?
...
![Image 20](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728811107048.png)
...
![Image 21](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728811321758.png)
...
![Image 22](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728812285853.png)
...
![Image 23](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728812550108.png)
...
![Image 24](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/62a7685ca6e7ce005d3f3afe-1728813246997.png)

You have seen how easily we deobfuscated and retrieved our original code.

Answer the questions belowWhat is the alert message shown after running the file **hello.html** ?

Correct AnswerWhat is the value of the **age**  variable in the following obfuscated code snippet?
...
**Question:** What is the value of the age variable in the following obfuscated code snippet?age=0x1*0x247e+0x35*-0x2e+-0x1ae3;
...
Answer the questions belowIs it a good practice to blindly include JS in your code from any source (yea/nay)?
...
Answer the questions belowI have successfully completed the room.
