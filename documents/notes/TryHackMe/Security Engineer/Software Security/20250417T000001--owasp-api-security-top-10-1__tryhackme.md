...
tags:       ["tryhackme"]
identifier: "20250417T000001"
Hubs: "TryHackMe/Security Engineer/Software Security"
urls: (https://tryhackme.com/room/owaspapisecuritytop105w)
id: d1267abf-6f78-4dab-8c7e-578d3e7dfaab
---
...
**Question:** In the LinkedIn breach (Jun 2021), how many million records (sample) were posted by a hacker on the dark web?

*Answer:* 

     1

**Question:** Is the API documentation a trivial item and not used after API development (yea/nay)?

*Answer:* 

     nay

**Question:** I understand the APIs and am ready to learn OWASP Top 10 Principles.
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/a6eec3c1ad211d50ca0ba20ba4f6898e.png)
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/d7276bdd5c3d6fe7b6eea7731d261210.png)
...
**Question:** Suppose the employee ID is an integer with incrementing value. Can you check through the vulnerable API endpoint the total number of employees in the company?

*Answer:* 

     3

**Question:** What is the flag associated with employee ID 2?

*Answer:* 

     THM{838123}

**Question:** What is the username of employee ID 3?
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/dedcd5391fc513261706967f2c0e34cf.png)
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/44ee6cbacf493eb437c3711ae413965e.png)
...
**Question:** Can you find the token of hr@mht.com?

*Answer:* 

     cOC%Aonyis%H)mZ&uJkuI?_W#4&m>Y

**Question:** To which country does sales@mht.com belong?

*Answer:* 

     China

**Question:** Is it a good practice to send a username and password in a GET request (yea/nay)?
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/6733955d8ce9471ce57924fb77a8caf6.png)
...
![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/23e044cc3efe648691292fac6f6e4acf.png)
...
**Question:** What is the device ID value for post-ID 2?

*Answer:* 

     iOS15.411

**Question:** What is the username value for post-ID 3?

*Answer:* 

     hacker#!

**Question:** Should we use network-level devices for controlling excessive data exposure instead of managing it through APIs (programmatically) - (yea/nay)?
...
![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/e893ab4958ff54d17bedf53a0e22d772.png)
...
![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/a47bc005c405264850984ca7fb19b24b.gif)
...
**Question:** Can rate limiting be carried out at the network level through firewall etc. (yea/nay)?

*Answer:* 

     yea

**Question:** What is the HTTP response code when you send a POST request to /apirule4/sendOTP_s using the email address hr@mht.com?

*Answer:* 

     200

**Question:** What is the "msg key" value after an HTTP POST request to /apirule4/sendOTP_s using the email address sale@mht.com?
...
![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/4fb8a31217d2d1af51cad8cbdc318754.png)
...
![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/62a7685ca6e7ce005d3f3afe/room-content/5a708a5bc9daad5002e4824a0eda5511.gif)
...
**Question:** What is the mobile number for the username Alice?

*Answer:* 

     +1235322323

**Question:** Is it a good practice to send isAdmin value through the hidden fields in form requests - yea/nay?

*Answer:* 

     nay

**Question:** What is the address flag of username admin?
...
**Question:** I have completed the room (Part 1).
