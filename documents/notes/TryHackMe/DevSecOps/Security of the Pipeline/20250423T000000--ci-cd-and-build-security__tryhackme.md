...
tags:       ["tryhackme"]
identifier: "20250423T000000"
Hubs: "TryHackMe/DevSecOps/Security of the Pipeline"
urls: (https://tryhackme.com/room/cicdandbuildsecurity)
id: d22797de-65d3-4837-aeac-6011a75c50ec
---
...
**Question:** I'm ready to learn about CI/CD and Build Security!
...
![Image 1](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/9cd599412c497e27c68c9dc9b0a98504.png)
...
![Image 2](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/e103425252562925b7feab754054f66d.png)
...
![Image 3](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/990b3e40c18bb16a990cde5410bd32fe.png)
...
**Question:** I am ready to start my CI/CD and Build security learning journey.

*Answer:* 

     No answer needed

**Question:** I am connected to the network using my preferred method of choice and can confirm that I can access the Gitlab server.

*Answer:* 

     No answer needed

**Question:** I have registered an account with Mother.
...
**Question:** What element of a CI/CD pipeline coordinates and manages the automation of build and deployment environments?

*Answer:* 

     build orchestrator

**Question:** What element of a CI/CD pipeline builds, tests, and packages code?

*Answer:* 

     build agents

**Question:** What fundamental of CI/CD promotes developers in having access to the latest builds and code in order to understand and see the changes that have been made?
...
![Image 4](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/55db0c02028b6c7628f8c22235ba8093.png)
...
![Image 5](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/ba274fe1b4b619508c2bea4961bba823.png)
...
![Image 6](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/ea7a7734618d95cd1a701e14402ebf81.png)
...
![Image 7](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/9a8bb9c51c2f90b6d38b880be4b10b2a.png)

Expand the Runners section, and you should see the following screen:

![Image 8](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/be6417445bc9a04a222c2f783cc3b24d.png)
...
![Image 9](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/ad7b6d1c752c0abc2580477167f066c3.png)
...
```
  ...
  Now that your runner is configured, you can refresh the page on Gitlab, and you should see your runner:![Image 10](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/8b798c1444c78b642199c08f3be01516.png)
...
![Image 11](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/84ff9051a95bc7a09eed29cf2887688b.png)
...
![Image 12](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/eb987192231a3765ee4a2936220bceff.png)
...
![Image 13](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/f7486c18218051d7cbf394915074ddf6.png)

You can also click on the pipeline to view its progress:

![Image 14](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/0ac8ac26762396a70e76c3f76e67cd53.png)
...
![Image 15](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/c18c9c2b2bcf7e4075cfe9e1dc54912e.png)
...
**Question:** What is the name of the build agent that can be used with Gitlab?

*Answer:* 

     Gitlab Runner

**Question:** What is the value of the flag you receive once authenticated to Timekeep?
...
![Image 16](https://tryhackme-images.s3.amazonaws.com/user-uploads/61a7523c029d1c004fac97b3/room-content/dc48bbb2b20c6149e5f5e28859905eb0.png)

2. Click on Access Tokens:

![Image 17](https://tryhackme-images.s3.amazonaws.com/user-uploads/61a7523c029d1c004fac97b3/room-content/4409fc960a7e0dddbb36228b67b76ba6.png)

3. Enter a name for a new API token and select the api, read_api, and read_repository scopes:

![Image 18](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/8bb03761c2a10024a9b92d30251174a0.png)

4. Click Create personal access token, reveal, and copy your access token to a safe location:

![Image 19](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/7c80e96791b36465b1494a2f81b41fb7.png)
...
4. 1. **GitLab's .gitignore**  : This file specifies which files or directories should be excluded from version control. It's crucial for preventing sensitive data like passwords, API keys, and configuration files from being committed to repositories.
...
**Question:** Which file specifies which directories and files should be excluded for version control?

*Answer:* 

     .gitignore

**Question:** What can you protect to ensure direct pushes and vulnerable code changes are avoided?

*Answer:* 

     branches

**Question:** What issue does lack of access control and unauthorised code changes lead to?

*Answer:* 

     unauthorised tampering

**Question:** What is the API key stored within the Mobile application that can be accessed by any Gitlab user?
...
![Image 20](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/c3d77fd5295a61972645e7b1cd5785c4.png)
...
![Image 21](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/e10e1413b8ac41c5a84443a2cb38bd65.png)

Forking will create a copy of the project. Select your namespace, mark the project as Private, and select Fork project:

![Image 22](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/62782c4148e9f1c3bc46a34702049b98.png)
...
Once you have made the edit, commit the changes. To have Jenkins execute our now malicious Jenkinsfile, we need to create a merge request:![Image 23](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/cc884baa3ca5695ade221851e2b67e9f.png)
...
**Question:** Where should you store artefacts to prevent tampering?

*Answer:* 

     secure registry

**Question:** What mechanism should you always use to store and inject sensitive data?

*Answer:* 

     secret management

**Question:** What attack can malicious actors perform to inject malicious code in the build process?

*Answer:* 

     dependency confusion

**Question:** Authenticate to Mother and follow the process to claim Flag 1. What is Flag 1?
...
![Image 24](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/72cdd7eb8412a7dae0f5a29031c6d520.png)

Let's try our luck with `jenkins:jenkins` and we should be authenticated!

![Image 25](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/bc09936ce7f6b8bb843ca3306a31d4a2.png)
...
5. **Token-Based Authentication** : Utilise build agent tokens for authentication, adding an extra layer of security.
6. **SSH Keys** : For SSH-based build agents, use secure SSH keys for authentication.
7. **Continuous Monitoring** : Regularly monitor build agent activities and logs for unusual behaviour.
...
**Question:** What can be used to ensure that remote access to the build server can be performed securely?

*Answer:* 

     VPN

**Question:** What can be used to add an additional layer of authentication security for build agents?

*Answer:* 

     Token-based authentication

**Question:** Authenticate to Mother and follow the process to claim Flag 2. What is Flag 2?
...
![Image 26](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/5d471dd234b7fc4eb4edea3c934663c1.png)

   **Username** anatacker **Password** Password1@    Ash has provided Ana with developer access to his Approval-Test repo, which can be found here: [http://gitlab.tryhackme.loc/ash/approval-test](http://gitlab.tryhackme.loc/ash/approval-test). To protect the main branch of the repo, Ash has configured the main branch to be a protected branch, where developers are only allowed to make merge requests and no direct code changes. Let's test this by updating the README file and trying to commit the change to the main branch. Navigate to the README file and click Edit:

![Image 27](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/b25688bbf71085e1c73f493123fa206e.png)
...
![Image 28](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/c635e79ca83fc5914d68fd7818eb8116.png)
...
![Image 29](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/35a2237a1b9a00e9323cc57fb43e78b3.png)
...
Protecting the PipelineProtecting your GitLab CI/CD pipeline is essential to ensure the security of your code and infrastructure. Here are steps you can take to protect your pipeline with access gates and prevent unauthorised code execution like the example above:
...
![Image 30](https://tryhackme-images.s3.amazonaws.com/user-uploads/61a7523c029d1c004fac97b3/room-content/59f53e8b497a103ef2fac4d1f7cd43c2.png)

![Image 31](https://tryhackme-images.s3.amazonaws.com/user-uploads/61a7523c029d1c004fac97b3/room-content/3a14d7b5725b25ea005dabfa126cd276.png)
...
**Question:** What can we add so that merges are raised for review instead of pushing the changes to code directly?

*Answer:* 

     merge requests

**Question:** What should we do so that only trusted runners execute CI/CD jobs?

*Answer:* 

     limit runner access

**Question:** Authenticate to Mother and follow the process to claim Flag 3. What is Flag 3?
...
A key security principle in our pipeline is to ensure that our different environments are segregated. Environments are not created equal, especially in these modern times where Agile principles are used. Developers are often provided with quite a lot of access and abilities in environments other than production (PROD) and pre-production (PREPROD). If you need a refresher on the different types of environments, take a look at [this room](http://tryhackme.com/jr/introtopipelineautomation). With these additional permissions, we need to make sure that there is adequate segregation between the various environments.
...
![Image 32](https://tryhackme-images.s3.amazonaws.com/user-uploads/61a7523c029d1c004fac97b3/room-content/181b067e9f88c1e4d0345ec6605e3d9d.png)
...
![Image 33](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/030f82f88a240d910122561278d1b65f.png)
...
![Image 34](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/d0c3156bd636b42c42d02ae635a354c9.png)
...
**Question:** What should you do so that a compromised environment doesn't affect other environments?

*Answer:* 

     isolate environments

**Question:** Authenticate to Mother and follow the process to claim Flag 4 from the DEV environment. What is Flag 4?

*Answer:* 

     THM{28f36e4a-7c35-4e4d-bede-be698ddf0883}

**Question:** Authenticate to Mother and follow the process to claim Flag 5 from the PROD environment. What is Flag 5?
...
![Image 35](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/185933ee3b6b3b0b94f1a7e903c0de5b.png)
...
![Image 36](https://tryhackme-images.s3.amazonaws.com/user-uploads/6093e17fa004d20049b6933e/room-content/8096bf2504d99fce279d30e27f3da62c.png)
...
**Question:** Is using environment variables enough to protect the build secrets? (yay or nay)

*Answer:* 

     nay

**Question:** What is the value of the PROD API_KEY?
...
**Question:** I understand CI/CD and Build Security!
